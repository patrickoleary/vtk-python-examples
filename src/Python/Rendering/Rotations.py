...
# Demonstrate all four rotation sequences (X, Y, Z, then X+Y) of the
# cow model with EraseOff overlay, reproducing VTK Textbook figures
# 3-31a through 3-31d in a single run.
...
render_window.SetWindowName("Rotations")
