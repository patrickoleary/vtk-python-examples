...
# Render a PBR cube with albedo, ORM, normal, and coat-normal texture maps
# demonstrating the clear-coat material layer.  A single directional light
# and HDR equirectangular environment map provide image-based lighting.
...
# Source: triangulated cube with tangent vectors for normal mapping
cube = vtkCubeSource()
...
# Texture: normal map (shared for both surface and coat normals)
...
# Actor: PBR cube with clear-coat layer
actor = vtkActor()
...
render_window.SetWindowName("PBR_Clear_Coat")
