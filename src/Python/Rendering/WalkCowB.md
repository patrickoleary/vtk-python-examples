...
This example thes cow rotating about a vector passing through her nose, with the origin set to the nose tip at (6.11414, 1.27386, 0.015175). Rendered with EraseOff overlay.
...
- [vtkTransform](https://www.vtk.org/doc/nightly/html/classvtkTransform.html) composes incremental rotations for the animation.
