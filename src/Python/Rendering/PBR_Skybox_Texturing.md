...
This example renders Boy's parametric surface with PBR texturing and an HDR skybox backdrop. Albedo, ORM (occlusion/roughness/metallic), and normal textures are applied. The environment map provides image-based lighting.
...
- [vtkPolyDataTangents](https://www.vtk.org/doc/nightly/html/classvtkPolyDataTangents.html) computes tangent vectors for PBR normal mapping.
