...
This example renders five rows of PBR metallic spheres with different edge tint colours and increasing roughness. An HDR equirectangular environment map provides image-based lighting.

**Source → Mapper → Actor → Renderer → Window → Interactor**

- [vtkActor](https://www.vtk.org/doc/nightly/html/classvtkActor.html) assigns the mapped geometry to the scene with PBR edge tint properties.
