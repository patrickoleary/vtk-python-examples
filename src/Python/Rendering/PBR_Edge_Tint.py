...
# Actors: five rows with different base color / edge tint combinations
row_params = [
    (0.0, white, black),    # row 0: white surface, black edge tint
    (1.0, black, white),    # row 1: black surface, white edge tint
    (2.0, blue, red),       # row 2: blue surface, red edge tint
    (3.0, red, blue),       # row 3: red surface, blue edge tint
    (4.0, black, yellow),   # row 4: black surface, yellow edge tint
]

for y, color, tint in row_params:
    for i in range(6):
        actor = vtkActor()
        ...
        actor.GetProperty().SetEdgeTint(tint)
...
render_window.SetWindowName("PBR_Edge_Tint")
