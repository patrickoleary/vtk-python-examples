...
This example renders a single quad linear cell using [vtkQuad](https://www.vtk.org/doc/nightly/html/classvtkQuad.html). The cell is displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkQuad](https://www.vtk.org/doc/nightly/html/classvtkQuad.html) defines the cell geometry.
