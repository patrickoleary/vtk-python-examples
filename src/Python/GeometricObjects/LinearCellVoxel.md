...
This example renders a single voxel linear cell using [vtkVoxel](https://www.vtk.org/doc/nightly/html/classvtkVoxel.html). The 3D cell is rotated for viewing and sits on a translucent plinth, with vertex-ordering labels and gold sphere glyphs. Note that vtkVoxel uses i,j,k axis-aligned ordering.
...
- [vtkCubeSource](https://www.vtk.org/doc/nightly/html/classvtkCubeSource.html) creates the translucent plinth.
...
- [vtkVoxel](https://www.vtk.org/doc/nightly/html/classvtkVoxel.html) defines the cell geometry.
