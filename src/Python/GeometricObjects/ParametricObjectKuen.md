...
This example renders a single vtkParametricKuen surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricKuen](https://www.vtk.org/doc/nightly/html/classvtkParametricKuen.html) defines the Kuen surface parametric equation with a custom DeltaV0 parameter.
