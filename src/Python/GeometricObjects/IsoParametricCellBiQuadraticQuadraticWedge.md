...
This example renders a single bi-quadratic quadratic wedge isoparametric cell using [vtkBiQuadraticQuadraticWedge](https://www.vtk.org/doc/nightly/html/classvtkBiQuadraticQuadraticWedge.html). The 3D cell is rotated for viewing, centered at the origin, and displayed with vertex-ordering labels, gold sphere glyphs, and a translucent plinth.
...
- [vtkBiQuadraticQuadraticWedge](https://www.vtk.org/doc/nightly/html/classvtkBiQuadraticQuadraticWedge.html) defines the cell geometry.
