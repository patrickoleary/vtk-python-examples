...
This example renders a single quadratic triangle isoparametric cell using [vtkQuadraticTriangle](https://www.vtk.org/doc/nightly/html/classvtkQuadraticTriangle.html). The cell is built from its parametric coordinates and displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkQuadraticTriangle](https://www.vtk.org/doc/nightly/html/classvtkQuadraticTriangle.html) defines the cell geometry.
