...
This example renders a single vtkParametricMobius surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricMobius](https://www.vtk.org/doc/nightly/html/classvtkParametricMobius.html) defines the Mobius strip parametric equation with custom radius and V range.
