...
This example renders a single vtkParametricConicSpiral surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricConicSpiral](https://www.vtk.org/doc/nightly/html/classvtkParametricConicSpiral.html) defines the conic spiral parametric equation.
