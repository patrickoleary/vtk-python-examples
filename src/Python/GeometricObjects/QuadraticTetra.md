...
This example renders a quadratic tetrahedron with tessellation and node glyphs. It follows the VTK pipeline structure:

**Data → Filter → Mapper → Actor → Renderer → Window → Interactor**

- [vtkActor](https://www.vtk.org/doc/nightly/html/classvtkActor.html) assigns visual properties — tomato diffuse color with black edges for the tetra, banana for the node glyphs.
...
- [vtkQuadraticTetra](https://www.vtk.org/doc/nightly/html/classvtkQuadraticTetra.html) defines a 10-node quadratic tetrahedral cell. Parametric coordinates are perturbed with [vtkMinimalStandardRandomSequence](https://www.vtk.org/doc/nightly/html/classvtkMinimalStandardRandomSequence.html) for visual interest.
