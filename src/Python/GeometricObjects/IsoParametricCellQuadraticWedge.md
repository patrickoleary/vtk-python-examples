...
This example renders a single quadratic wedge isoparametric cell using [vtkQuadraticWedge](https://www.vtk.org/doc/nightly/html/classvtkQuadraticWedge.html). The 3D cell is rotated for viewing, centered at the origin, and displayed with vertex-ordering labels, gold sphere glyphs, and a translucent plinth.
...
- [vtkQuadraticWedge](https://www.vtk.org/doc/nightly/html/classvtkQuadraticWedge.html) defines the cell geometry.
