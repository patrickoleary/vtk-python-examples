...
This example renders a single bi-quadratic quad isoparametric cell using [vtkBiQuadraticQuad](https://www.vtk.org/doc/nightly/html/classvtkBiQuadraticQuad.html). The cell is built from its parametric coordinates and displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkBiQuadraticQuad](https://www.vtk.org/doc/nightly/html/classvtkBiQuadraticQuad.html) defines the cell geometry.
