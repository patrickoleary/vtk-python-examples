...
This example renders a single hexahedron linear cell using [vtkHexahedron](https://www.vtk.org/doc/nightly/html/classvtkHexahedron.html). The 3D cell is rotated for viewing and sits on a translucent plinth, with vertex-ordering labels and gold sphere glyphs.
...
- [vtkHexahedron](https://www.vtk.org/doc/nightly/html/classvtkHexahedron.html) defines the cell geometry.
