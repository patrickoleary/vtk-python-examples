...
This example renders a single quadratic edge isoparametric cell using [vtkQuadraticEdge](https://www.vtk.org/doc/nightly/html/classvtkQuadraticEdge.html). The cell is built from its parametric coordinates and displayed as wireframe with vertex-ordering labels and gold sphere glyphs.
...
- [vtkQuadraticEdge](https://www.vtk.org/doc/nightly/html/classvtkQuadraticEdge.html) defines the cell geometry.
