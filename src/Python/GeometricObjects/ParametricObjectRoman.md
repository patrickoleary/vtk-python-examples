...
This example renders a single vtkParametricRoman surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricRoman](https://www.vtk.org/doc/nightly/html/classvtkParametricRoman.html) defines the Steiner Roman surface parametric equation.
