...
This example renders a single quadratic polygon isoparametric cell using [vtkQuadraticPolygon](https://www.vtk.org/doc/nightly/html/classvtkQuadraticPolygon.html). Unlike other isoparametric cells, the quadratic polygon uses explicitly defined point coordinates rather than parametric coordinates. It is displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkQuadraticPolygon](https://www.vtk.org/doc/nightly/html/classvtkQuadraticPolygon.html) defines the cell geometry.
