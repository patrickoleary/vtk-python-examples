...
This example renders a single polygon linear cell using [vtkPolygon](https://www.vtk.org/doc/nightly/html/classvtkPolygon.html). The cell is displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkPolygon](https://www.vtk.org/doc/nightly/html/classvtkPolygon.html) defines the cell geometry.
