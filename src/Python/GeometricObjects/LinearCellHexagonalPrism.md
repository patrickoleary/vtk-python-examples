...
This example renders a single hexagonal prism linear cell using [vtkHexagonalPrism](https://www.vtk.org/doc/nightly/html/classvtkHexagonalPrism.html). The 3D cell is rotated for viewing and sits on a translucent plinth, with vertex-ordering labels and gold sphere glyphs.
...
- [vtkHexagonalPrism](https://www.vtk.org/doc/nightly/html/classvtkHexagonalPrism.html) defines the cell geometry.
