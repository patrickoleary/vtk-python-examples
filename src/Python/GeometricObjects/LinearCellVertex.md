...
This example renders a single vertex linear cell using [vtkVertex](https://www.vtk.org/doc/nightly/html/classvtkVertex.html). The cell is displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkVertex](https://www.vtk.org/doc/nightly/html/classvtkVertex.html) defines the cell geometry.
