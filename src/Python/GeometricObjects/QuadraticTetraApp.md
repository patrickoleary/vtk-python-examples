...
This example thises interactive demo renders a quadratic tetrahedron with a slider widget that controls the chord error of vtkTessellatorFilter. Drag the slider to see the tessellation edges update in real time. It follows the VTK pipeline structure:
...
- [vtkQuadraticTetra](https://www.vtk.org/doc/nightly/html/classvtkQuadraticTetra.html) defines a 10-node quadratic tetrahedral cell with perturbed nodes.
