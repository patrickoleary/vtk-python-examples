...
This example interactives demo of a super-toroid parametric surface. Two sliders control the N1 (Z squareness) and N2 (XY squareness) exponents in real time. It follows the VTK pipeline structure:
...
- [vtkParametricSuperToroid](https://www.vtk.org/doc/nightly/html/classvtkParametricSuperToroid.html) defines the super-toroid equations with adjustable N1 and N2 exponents.
