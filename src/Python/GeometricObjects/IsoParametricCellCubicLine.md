...
This example renders a single cubic line isoparametric cell using [vtkCubicLine](https://www.vtk.org/doc/nightly/html/classvtkCubicLine.html). The cell is built from its parametric coordinates and displayed as wireframe with vertex-ordering labels and gold sphere glyphs.
...
- [vtkCubicLine](https://www.vtk.org/doc/nightly/html/classvtkCubicLine.html) defines the cell geometry.
