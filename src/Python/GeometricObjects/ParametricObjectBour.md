...
This example renders a single vtkParametricBour surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricBour](https://www.vtk.org/doc/nightly/html/classvtkParametricBour.html) defines the Bour minimal surface parametric equation.
