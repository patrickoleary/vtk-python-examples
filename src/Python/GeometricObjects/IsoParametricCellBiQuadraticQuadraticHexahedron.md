...
This example renders a single bi-quadratic quadratic hexahedron isoparametric cell using [vtkBiQuadraticQuadraticHexahedron](https://www.vtk.org/doc/nightly/html/classvtkBiQuadraticQuadraticHexahedron.html). The 3D cell is rotated for viewing, centered at the origin, and displayed with vertex-ordering labels, gold sphere glyphs, and a translucent plinth.
...
- [vtkBiQuadraticQuadraticHexahedron](https://www.vtk.org/doc/nightly/html/classvtkBiQuadraticQuadraticHexahedron.html) defines the cell geometry.
