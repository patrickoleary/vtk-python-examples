...
This example renders a single vtkParametricPluckerConoid surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricPluckerConoid](https://www.vtk.org/doc/nightly/html/classvtkParametricPluckerConoid.html) defines the Plucker conoid parametric equation.
