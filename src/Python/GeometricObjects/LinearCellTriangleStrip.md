...
This example renders a single triangle strip linear cell using [vtkTriangleStrip](https://www.vtk.org/doc/nightly/html/classvtkTriangleStrip.html). The cell is displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkTriangleStrip](https://www.vtk.org/doc/nightly/html/classvtkTriangleStrip.html) defines the cell geometry.
