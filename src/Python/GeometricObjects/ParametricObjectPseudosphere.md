...
This example renders a single vtkParametricPseudosphere surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricPseudosphere](https://www.vtk.org/doc/nightly/html/classvtkParametricPseudosphere.html) defines the pseudosphere parametric equation.
