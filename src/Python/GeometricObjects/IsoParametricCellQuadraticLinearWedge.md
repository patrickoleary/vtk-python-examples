...
This example renders a single quadratic linear wedge isoparametric cell using [vtkQuadraticLinearWedge](https://www.vtk.org/doc/nightly/html/classvtkQuadraticLinearWedge.html). The 3D cell is rotated for viewing, centered at the origin, and displayed with vertex-ordering labels, gold sphere glyphs, and a translucent plinth.
...
- [vtkQuadraticLinearWedge](https://www.vtk.org/doc/nightly/html/classvtkQuadraticLinearWedge.html) defines the cell geometry.
