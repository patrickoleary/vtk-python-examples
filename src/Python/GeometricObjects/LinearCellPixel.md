...
This example renders a single pixel linear cell using [vtkPixel](https://www.vtk.org/doc/nightly/html/classvtkPixel.html). The cell is displayed with vertex-ordering labels and gold sphere glyphs. Note that vtkPixel uses i,j axis-aligned ordering.
...
- [vtkPixel](https://www.vtk.org/doc/nightly/html/classvtkPixel.html) defines the cell geometry.
