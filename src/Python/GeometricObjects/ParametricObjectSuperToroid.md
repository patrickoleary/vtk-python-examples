...
This example renders a single vtkParametricSuperToroid surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricSuperToroid](https://www.vtk.org/doc/nightly/html/classvtkParametricSuperToroid.html) defines the super-toroid parametric equation with custom N1 and N2 exponents.
