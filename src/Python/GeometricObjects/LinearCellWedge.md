...
This example renders a single wedge linear cell using [vtkWedge](https://www.vtk.org/doc/nightly/html/classvtkWedge.html). The 3D cell is rotated for viewing and sits on a translucent plinth, with vertex-ordering labels and gold sphere glyphs.
...
- [vtkWedge](https://www.vtk.org/doc/nightly/html/classvtkWedge.html) defines the cell geometry.
