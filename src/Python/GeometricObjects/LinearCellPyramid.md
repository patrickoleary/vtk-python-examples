...
This example renders a single pyramid linear cell using [vtkPyramid](https://www.vtk.org/doc/nightly/html/classvtkPyramid.html). The 3D cell is rotated for viewing and sits on a translucent plinth, with vertex-ordering labels and gold sphere glyphs.
...
- [vtkPyramid](https://www.vtk.org/doc/nightly/html/classvtkPyramid.html) defines the cell geometry.
