...
This example renders a single vtkParametricBoy surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricBoy](https://www.vtk.org/doc/nightly/html/classvtkParametricBoy.html) defines Boy's surface parametric equation.
