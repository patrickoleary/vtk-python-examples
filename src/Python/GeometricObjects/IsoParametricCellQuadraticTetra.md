...
This example renders a single quadratic tetrahedron isoparametric cell using [vtkQuadraticTetra](https://www.vtk.org/doc/nightly/html/classvtkQuadraticTetra.html). The 3D cell is rotated for viewing, centered at the origin, and displayed with vertex-ordering labels, gold sphere glyphs, and a translucent plinth.
...
- [vtkQuadraticTetra](https://www.vtk.org/doc/nightly/html/classvtkQuadraticTetra.html) defines the cell geometry.
