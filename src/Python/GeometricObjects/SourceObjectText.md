...
This example renders 3D text using [vtkTextSource](https://www.vtk.org/doc/nightly/html/classvtkTextSource.html) with a peach puff front face and tomato back-face property.
