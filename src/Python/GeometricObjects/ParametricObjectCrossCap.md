...
This example renders a single vtkParametricCrossCap surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricCrossCap](https://www.vtk.org/doc/nightly/html/classvtkParametricCrossCap.html) defines the cross-cap parametric equation.
