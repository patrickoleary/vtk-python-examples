...
This example renders a single tetrahedron linear cell using [vtkTetra](https://www.vtk.org/doc/nightly/html/classvtkTetra.html). The 3D cell is rotated for viewing and sits on a translucent plinth, with vertex-ordering labels and gold sphere glyphs.
...
- [vtkTetra](https://www.vtk.org/doc/nightly/html/classvtkTetra.html) defines the cell geometry.
