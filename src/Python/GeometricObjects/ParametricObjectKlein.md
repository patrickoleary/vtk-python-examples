...
This example renders a single vtkParametricKlein surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricKlein](https://www.vtk.org/doc/nightly/html/classvtkParametricKlein.html) defines the Klein bottle parametric equation.
