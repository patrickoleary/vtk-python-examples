...
This example renders a single triangle linear cell using [vtkTriangle](https://www.vtk.org/doc/nightly/html/classvtkTriangle.html). The cell is displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkTriangle](https://www.vtk.org/doc/nightly/html/classvtkTriangle.html) defines the cell geometry.
