...
This example renders a single vtkParametricEllipsoid surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricEllipsoid](https://www.vtk.org/doc/nightly/html/classvtkParametricEllipsoid.html) defines the ellipsoid parametric equation with custom X and Y radii.
