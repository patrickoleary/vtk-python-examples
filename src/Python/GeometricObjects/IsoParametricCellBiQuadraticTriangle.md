...
This example renders a single bi-quadratic triangle isoparametric cell using [vtkBiQuadraticTriangle](https://www.vtk.org/doc/nightly/html/classvtkBiQuadraticTriangle.html). The cell is built from its parametric coordinates and displayed with vertex-ordering labels and gold sphere glyphs.
...
- [vtkBiQuadraticTriangle](https://www.vtk.org/doc/nightly/html/classvtkBiQuadraticTriangle.html) defines the cell geometry.
