...
This example renders a single octahedron Platonic solid with each face colored using a lookup table so adjacent faces are visually distinct. It follows the VTK pipeline structure:
...
- [vtkPlatonicSolidSource](https://www.vtk.org/doc/nightly/html/classvtkPlatonicSolidSource.html) generates the octahedron (solid type 2). Each face receives a unique cell scalar.
