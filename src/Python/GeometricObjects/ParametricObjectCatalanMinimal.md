...
This example renders a single vtkParametricCatalanMinimal surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricCatalanMinimal](https://www.vtk.org/doc/nightly/html/classvtkParametricCatalanMinimal.html) defines the Catalan minimal surface parametric equation.
