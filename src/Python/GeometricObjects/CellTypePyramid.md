...
This example demonstrates [vtkCellTypeSource](https://www.vtk.org/doc/nightly/html/classvtkCellTypeSource.html) for the Pyramid cell type. The source generates an unstructured grid of pyramid cells, which are perturbed, shrunk, tessellated, and color-mapped by cell ID. It follows the standard VTK pipeline structure:
...
- [vtkCellTypeSource](https://www.vtk.org/doc/nightly/html/classvtkCellTypeSource.html) generates a [vtkUnstructuredGrid](https://www.vtk.org/doc/nightly/html/classvtkUnstructuredGrid.html) of pyramid cells via `SetCellType()`.
