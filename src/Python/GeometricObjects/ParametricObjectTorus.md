...
This example renders a single vtkParametricTorus surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricTorus](https://www.vtk.org/doc/nightly/html/classvtkParametricTorus.html) defines the torus parametric equation.
