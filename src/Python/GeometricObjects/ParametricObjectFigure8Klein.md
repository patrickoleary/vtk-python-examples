...
This example renders a single vtkParametricFigure8Klein surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricFigure8Klein](https://www.vtk.org/doc/nightly/html/classvtkParametricFigure8Klein.html) defines the figure-8 Klein bottle parametric equation.
