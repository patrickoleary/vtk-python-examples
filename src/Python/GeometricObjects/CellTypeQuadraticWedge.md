...
This example demonstrates [vtkCellTypeSource](https://www.vtk.org/doc/nightly/html/classvtkCellTypeSource.html) for the Quadratic Wedge cell type. The source generates an unstructured grid of quadratic wedge cells, which are perturbed, shrunk, and color-mapped by cell ID. It follows the standard VTK pipeline structure:
...
- [vtkCellTypeSource](https://www.vtk.org/doc/nightly/html/classvtkCellTypeSource.html) generates a [vtkUnstructuredGrid](https://www.vtk.org/doc/nightly/html/classvtkUnstructuredGrid.html) of quadratic wedge cells via `SetCellType()`.
