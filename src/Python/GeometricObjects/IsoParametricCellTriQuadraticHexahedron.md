...
This example renders a single tri-quadratic hexahedron isoparametric cell using [vtkTriQuadraticHexahedron](https://www.vtk.org/doc/nightly/html/classvtkTriQuadraticHexahedron.html). The 3D cell is rotated for viewing, centered at the origin, and displayed with vertex-ordering labels, gold sphere glyphs, and a translucent plinth.
...
- [vtkTriQuadraticHexahedron](https://www.vtk.org/doc/nightly/html/classvtkTriQuadraticHexahedron.html) defines the cell geometry.
