...
This example renders a single quadratic pyramid isoparametric cell using [vtkQuadraticPyramid](https://www.vtk.org/doc/nightly/html/classvtkQuadraticPyramid.html). The pyramid is pre-rotated −90° about the X axis so its apex points upward, then rotated for 3D viewing. It is displayed with vertex-ordering labels, gold sphere glyphs, and a translucent plinth.
...
- [vtkQuadraticPyramid](https://www.vtk.org/doc/nightly/html/classvtkQuadraticPyramid.html) defines the cell geometry.
