...
This example renders a single vtkParametricRandomHills surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricRandomHills](https://www.vtk.org/doc/nightly/html/classvtkParametricRandomHills.html) defines a surface of random hills with a fixed seed and 30 hills.
