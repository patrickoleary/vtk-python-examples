...
This example renders a single vtkParametricDini surface, centered and normalized to fit the viewport. It follows the VTK pipeline structure:
...
- [vtkParametricDini](https://www.vtk.org/doc/nightly/html/classvtkParametricDini.html) defines the Dini surface parametric equation.
