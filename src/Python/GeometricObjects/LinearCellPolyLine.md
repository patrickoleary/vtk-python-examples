...
This example renders a single poly line linear cell using [vtkPolyLine](https://www.vtk.org/doc/nightly/html/classvtkPolyLine.html). The cell is displayed as wireframe with vertex-ordering labels and gold sphere glyphs.
...
- [vtkPolyLine](https://www.vtk.org/doc/nightly/html/classvtkPolyLine.html) defines the cell geometry.
