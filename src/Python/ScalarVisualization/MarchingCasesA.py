...
# Marching cubes case table: (vertex pattern, label)
# fmt: off
CASE_TABLE = [
    ([0, 0, 0, 0, 0, 0, 0, 0], "Case 0 - 00000000"),
    ([1, 0, 0, 0, 0, 0, 0, 0], "Case 1 - 00000001"),
    ([1, 1, 0, 0, 0, 0, 0, 0], "Case 2 - 00000011"),
    ([1, 0, 1, 0, 0, 0, 0, 0], "Case 3 - 00000101"),
    ([1, 0, 0, 0, 0, 0, 1, 0], "Case 4 - 01000001"),
    ([0, 1, 0, 0, 1, 1, 0, 0], "Case 5 - 00110010"),
    ([0, 1, 0, 1, 1, 0, 0, 0], "Case 6 - 00011010"),
    ([1, 1, 0, 0, 0, 0, 1, 0], "Case 7 - 01000011"),
    ([1, 1, 0, 0, 1, 1, 0, 0], "Case 8 - 00110011"),
    ([0, 1, 1, 1, 0, 0, 1, 0], "Case 9 - 01001110"),
    ([1, 0, 0, 1, 0, 1, 1, 0], "Case 10 - 01101001"),
    ([1, 0, 0, 0, 1, 1, 1, 0], "Case 11 - 01110001"),
    ([0, 1, 0, 1, 1, 1, 0, 0], "Case 12 - 00111010"),
    ([0, 1, 0, 1, 1, 0, 1, 0], "Case 13 - 01011010"),
    ([1, 0, 1, 1, 0, 1, 1, 1], "Case 14 - 11101101"),
]
# fmt: on
...
render_window.SetWindowName("MarchingCasesA")

# Build each case in its own renderer
for i, (pattern, label_str) in enumerate(CASE_TABLE):
