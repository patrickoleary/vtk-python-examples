...
This example visualizes office airflow using streamlines seeded near the window.
...
- [vtkPointSource](https://www.vtk.org/doc/nightly/html/classvtkPointSource.html) generates seed points near the window.
