...
# Visualize office airflow using streamlines seeded near the bookshelf.
...
# Source: seed points for streamlines near the bookshelf (center 3)
seeds = vtkPointSource()
seeds.SetRadius(0.075)
seeds.SetCenter(0.08, 2.7, 0.5)
...
render_window.SetWindowName("Office")
