...
This example renders a sphere, captures the render window contents to a JPEG image file, and displays the scene.
...
- [vtkJPEGWriter](https://www.vtk.org/doc/nightly/html/classvtkJPEGWriter.html) writes the captured image to a JPEG file. JPEG uses lossy compression, making it suitable for photographic images where small artifacts are acceptable.
