...
This example renders a sphere, captures the render window contents to a PNG image file, and displays the scene.
...
- [vtkPNGWriter](https://www.vtk.org/doc/nightly/html/classvtkPNGWriter.html) writes the captured image to a PNG file. PNG supports lossless compression and is widely used for screenshots.
