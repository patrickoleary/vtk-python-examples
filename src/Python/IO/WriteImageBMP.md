...
This example renders a sphere, captures the render window contents to a BMP image file, and displays the scene.
...
- [vtkBMPWriter](https://www.vtk.org/doc/nightly/html/classvtkBMPWriter.html) writes the captured image to a BMP file. BMP is an uncompressed raster format commonly used on Windows platforms.
