#!/usr/bin/env python
# Demonstrate vtkMoleculeMapper with bond coloring in discrete-by-atom mode.
...
# Molecule mapper: bonds only, discrete-by-atom coloring.
...
render_window.SetWindowName("bond color mode discrete by atom")
