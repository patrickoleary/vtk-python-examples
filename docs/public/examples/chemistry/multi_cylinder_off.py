#!/usr/bin/env python
# Demonstrate vtkMoleculeMapper with multi-cylinder bonds disabled.
...
# Molecule mapper: bonds only, multi-cylinders off.
mol_mapper = vtkMoleculeMapper()
mol_mapper.SetInputData(mol)
mol_mapper.UseBallAndStickSettings()
mol_mapper.RenderAtomsOff()
mol_mapper.UseMultiCylindersForBondsOff()
...
render_window.SetWindowName("multi cylinder off")
