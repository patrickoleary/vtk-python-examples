#!/usr/bin/env python
# Demonstrate vtkMoleculeMapper with ball-and-stick rendering of a small molecule.
...
# Build molecule (acrolein-like structure).
mol = vtkMolecule()
mol.Initialize()
...
render_window.SetWindowName("ball and stick")
