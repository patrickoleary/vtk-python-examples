#!/usr/bin/env python
# Demonstrate vtkMoleculeMapper with bond coloring in single-color mode.
...
# Molecule mapper: bonds only, single-color mode.
...
render_window.SetWindowName("bond color mode single color")
