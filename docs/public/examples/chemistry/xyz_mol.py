...
# Read an XYZ molecule file and render atoms as glyphs with tube bonds.
...
from vtkmodules.vtkIOChemistry import vtkXYZMolReader
...
# Read XYZ file
xyz_mol_reader = vtkXYZMolReader()
xyz_mol_reader.SetFileName(os.path.join(data_dir, "thio3xx.xyz"))
...
glyph_filter.SetInputConnection(xyz_mol_reader.GetOutputPort())
...
tube_filter.SetInputConnection(xyz_mol_reader.GetOutputPort())
...
render_window.SetWindowName("xyz mol")
