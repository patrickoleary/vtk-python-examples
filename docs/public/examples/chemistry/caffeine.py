...
# Read caffeine PDB file and render atoms as glyphs with tube bonds.
...
pdb_reader.SetFileName(os.path.join(data_dir, "caffeine.pdb"))
...
render_window.SetWindowName("caffeine")
