#!/usr/bin/env python
# Demonstrate vtkMoleculeMapper with fast rendering settings.
...
# Molecule mapper with fast settings.
mol_mapper = vtkMoleculeMapper()
mol_mapper.SetInputData(mol)
mol_mapper.UseFastSettings()
...
render_window.SetWindowName("fast render")
