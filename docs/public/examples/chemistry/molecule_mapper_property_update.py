#!/usr/bin/env python
# Demonstrate vtkMoleculeMapper property update from ball-and-stick to VDW spheres.
...
# Molecule mapper starts with ball-and-stick.
...
render_window.SetWindowName("molecule mapper property update")

# Trigger initial render, then switch to VDW spheres.
render_window.Render()
mol_mapper.UseVDWSpheresSettings()
