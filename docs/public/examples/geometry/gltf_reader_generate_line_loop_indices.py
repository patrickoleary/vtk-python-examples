...
# Read a glTF file with LINE_LOOP primitive mode (generated indices) and render.
...
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "PrimitiveModes", "Mesh_PrimitiveMode_LINE_LOOP.gltf"))
gltf_reader.Update()
...
render_window.SetWindowName("gltf reader generate line loop indices")
