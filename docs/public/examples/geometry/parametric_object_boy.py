...
# Render a single vtkParametricBoy surface, centered and
...
# Parametric function: define Boy's surface
parametric_fn = vtkParametricBoy()
...
render_window.SetWindowName("parametric object boy")
