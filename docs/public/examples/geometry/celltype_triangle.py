...
# Demonstrate vtkCellTypeSource for the Triangle cell type. The source
# generates an unstructured grid of triangle cells, which are perturbed,
...
# Source: generate triangle cells
source = vtkCellTypeSource()
source.SetCellType(VTK_TRIANGLE)
source.Update()
...
render_window.SetWindowName("celltype triangle")
