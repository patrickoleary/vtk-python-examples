...
# Render a single vtkParametricCatalanMinimal surface, centered and
...
# Parametric function: define the Catalan minimal surface
parametric_fn = vtkParametricCatalanMinimal()
...
render_window.SetWindowName("parametric object catalan minimal")
