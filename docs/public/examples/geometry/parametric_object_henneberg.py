...
# Render a single vtkParametricHenneberg surface, centered and
...
# Parametric function: define the Henneberg minimal surface
parametric_fn = vtkParametricHenneberg()
...
render_window.SetWindowName("parametric object henneberg")
