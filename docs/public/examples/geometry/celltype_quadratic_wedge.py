...
# Demonstrate vtkCellTypeSource for the Quadratic Wedge cell type. The source
# generates an unstructured grid of quadratic wedge cells, which are perturbed,
# shrunk, and color-mapped by cell ID.
...
# Source: generate quadratic wedge cells
source = vtkCellTypeSource()
source.SetCellType(VTK_QUADRATIC_WEDGE)
source.Update()
...
render_window.SetWindowName("celltype quadratic wedge")
