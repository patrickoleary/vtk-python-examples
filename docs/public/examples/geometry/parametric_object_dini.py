...
# Render a single vtkParametricDini surface, centered and
...
# Parametric function: define the Dini surface
parametric_fn = vtkParametricDini()
...
render_window.SetWindowName("parametric object dini")
