...
# Demonstrate vtkCellTypeSource for the Quad cell type. The source generates
# an unstructured grid of quad cells, which are perturbed, shrunk,
# tessellated, and color-mapped by cell ID.
...
# Source: generate quad cells
cell_type_source = vtkCellTypeSource()
cell_type_source.SetCellType(VTK_QUAD)
...
render_window.SetWindowName("celltype quad")
