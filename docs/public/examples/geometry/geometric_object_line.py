...
# Render a line segment using vtkLineSource. The source produces a single
# line between two points, defaulting to (-0.5, 0, 0) and (0.5, 0, 0).
...
render_window.SetWindowName("geometric object line")
