...
# Render a single quadratic polygon isoparametric cell with vertex-ordering
# labels and gold sphere glyphs at the vertices. The quadratic polygon uses
# explicitly defined points (not parametric coordinates).
...
# Cell: explicitly defined 8-point quadratic polygon
...
render_window.SetWindowName("isoparametric cell quadratic polygon")
