...
# Read a glTF file with skinning and render at a specific time step.
...
# Read skinned glTF file
step = 200
gltf_reader = vtkGLTFReader()
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "SimpleSkin", "SimpleSkin.gltf"))
...
render_window.SetWindowName("gltf reader skinning")
