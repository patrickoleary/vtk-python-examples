...
# Read a glTF file with LINES primitive mode (read indices) and render.
...
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "PrimitiveModes", "Mesh_PrimitiveMode_LINES_2.gltf"))
gltf_reader.Update()
...
render_window.SetWindowName("gltf reader read line indices")
