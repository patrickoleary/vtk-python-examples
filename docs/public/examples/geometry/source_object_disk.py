...
# Render a disk using vtkDiskSource with a tomato back-face.
...
# Source: generate disk polygon data
source = vtkDiskSource()
source.SetCircumferentialResolution(51)
...
render_window.SetWindowName("source object disk")
