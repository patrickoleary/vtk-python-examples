...
# Demonstrate vtkWindowedSincPolyDataFilter with Hamming window on a
# semi-cylinder created via vtkRotationalExtrusionFilter, warped with
# Brownian points, then smoothed and rendered with normals.
...
# Windowed sinc smoothing with Hamming window
...
render_window.SetWindowName("smooth cylinder hamming")
