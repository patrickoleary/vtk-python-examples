...
# Render a single quadratic pyramid isoparametric cell with vertex-ordering
# labels, gold sphere glyphs at the vertices, and a translucent plinth.
# The pyramid is pre-rotated -90 about X before the standard 3D viewing rotation.
...
# Pre-rotate -90 about X so the apex points upward
t = vtkTransform()
t.RotateX(-90)
...
render_window.SetWindowName("isoparametric cell quadratic pyramid")
