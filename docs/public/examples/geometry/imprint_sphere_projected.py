...
# Demonstrate vtkImprintFilter with sphere sources using projected imprint
# output type, rendering the imprinted result colored by cell field data.
...
imprint_filter.SetOutputTypeToProjectedImprint()
imprint_filter.SetTolerance(0.085)
...
render_window.SetWindowName("imprint sphere projected")
