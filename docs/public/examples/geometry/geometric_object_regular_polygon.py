...
# Render a regular polygon using vtkRegularPolygonSource. The source produces
# a polygonal disk with a configurable number of sides, centered at the origin.
...
# Source: generate regular polygon geometry
...
render_window.SetWindowName("geometric object regular polygon")
