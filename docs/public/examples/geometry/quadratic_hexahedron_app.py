...
# Interactive demo of a quadratic hexahedron.  A slider adjusts the chord
...
render_window.SetWindowName("quadratic hexahedron app")
...
slider_widget.AddObserver(
    ...
    lambda obj, ev: (
        ...
        tessellate.SetMaximumNumberOfSubdivisions(4),
        tessellate.Update(),
    ),
)
