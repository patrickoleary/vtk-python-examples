...
# Render a single bi-quadratic quadratic hexahedron isoparametric cell with
...
render_window.SetWindowName("isoparametric cell bi quadratic quadratic hexahedron")
