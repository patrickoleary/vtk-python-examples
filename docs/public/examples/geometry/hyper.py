...
# Demonstrate vtkHyperStreamline by generating a point-load tensor field,
# creating four hyperstreamlines that integrate the minor eigenvector,
# and rendering them with a context plane, outline, and load cone.
...
tensor_input = pt_load.GetOutput()
...
streamline_1.SetInputData(tensor_input)
...
streamline_2.SetInputData(tensor_input)
...
streamline_2_mapper.SetScalarRange(tensor_input.GetScalarRange())
...
streamline_3.SetInputData(tensor_input)
...
streamline_3_mapper.SetScalarRange(tensor_input.GetScalarRange())
...
streamline_4.SetInputData(tensor_input)
...
streamline_4_mapper.SetScalarRange(tensor_input.GetScalarRange())
...
geometry.SetInputData(tensor_input)
...
outline.SetInputData(tensor_input)
...
render_window.SetWindowName("hyper")
