...
# Read a glTF file with embedded geometry and render.
...
# Read embedded glTF file
gltf_reader = vtkGLTFReader()
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "Triangle", "EmbeddedTriangle.gltf"))
gltf_reader.Update()
...
render_window.SetWindowName("gltf reader embedded")
