...
# Demonstrate vtkCellTypeSource for the Line cell type. The source generates
# an unstructured grid of line cells, which are perturbed, shrunk, tessellated,
# and color-mapped by cell ID.
...
# Source: generate line cells
cell_type_source = vtkCellTypeSource()
cell_type_source.SetCellType(VTK_LINE)
...
render_window.SetWindowName("celltype line")
