...
# Demonstrate vtkCellTypeSource for the Quadratic Triangle cell type. The
# source generates an unstructured grid of quadratic triangle cells, which are
# perturbed, shrunk, tessellated, and color-mapped by cell ID.
...
# Source: generate quadratic triangle cells
source = vtkCellTypeSource()
source.SetCellType(VTK_QUADRATIC_TRIANGLE)
source.Update()
...
render_window.SetWindowName("celltype quadratic triangle")
