...
# Render a single vtkParametricRandomHills surface, centered and
...
# Parametric function: define a random hills surface with fixed seed
parametric_fn = vtkParametricRandomHills()
parametric_fn.AllowRandomGenerationOn()
parametric_fn.SetRandomSeed(1)
parametric_fn.SetNumberOfHills(30)
...
render_window.SetWindowName("parametric object random hills")
