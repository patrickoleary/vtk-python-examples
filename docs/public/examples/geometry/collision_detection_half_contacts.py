...
# Demonstrate vtkCollisionDetectionFilter in HalfContacts mode by creating
...
# Collision detection filter — HalfContacts mode
...
render_window.SetWindowName("collision detection half contacts")
