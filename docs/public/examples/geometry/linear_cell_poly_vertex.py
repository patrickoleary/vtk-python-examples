...
# Render a single poly vertex linear cell with vertex-ordering labels and
# gold sphere glyphs at the vertices.  The 3D point cloud is rotated for
# viewing and sits on a translucent plinth.
...
# Cell: Poly Vertex with 6 explicitly placed points
sf = 1.5
points = vtkPoints()
points.InsertNextPoint(0 / sf, 0 / sf, 0 / sf)
points.InsertNextPoint(1 / sf, 0 / sf, 0 / sf)
points.InsertNextPoint(0 / sf, 1 / sf, 0 / sf)
points.InsertNextPoint(0 / sf, 0 / sf, 1 / sf)
points.InsertNextPoint(1 / sf, 0 / sf, 0.4 / sf)
points.InsertNextPoint(0 / sf, 1 / sf, 0.6 / sf)

cell = vtkPolyVertex()
cell.GetPointIds().SetNumberOfIds(6)
for i in range(6):
...
render_window.SetWindowName("linear cell poly vertex")
