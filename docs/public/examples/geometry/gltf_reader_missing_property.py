...
# Read a glTF file with missing pbrMetallicRoughness property and render.
...
# Read glTF file with missing material property
gltf_reader = vtkGLTFReader()
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "Triangle", "material-no-pbrMetallicRoughness.gltf"))
gltf_reader.Update()
...
render_window.SetWindowName("gltf reader missing property")
