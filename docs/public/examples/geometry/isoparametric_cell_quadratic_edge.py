...
# Render a single quadratic edge isoparametric cell with vertex-ordering
...
# Cell surface: wireframe for 1D cells
...
render_window.SetWindowName("isoparametric cell quadratic edge")
