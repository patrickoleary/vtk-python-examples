...
# Render a single vtkParametricFigure8Klein surface, centered and
...
# Parametric function: define the figure-8 Klein bottle surface
parametric_fn = vtkParametricFigure8Klein()
...
render_window.SetWindowName("parametric object figure 8 klein")
