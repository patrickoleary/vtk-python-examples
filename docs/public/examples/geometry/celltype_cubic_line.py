...
# Demonstrate vtkCellTypeSource for the Cubic Line cell type. The source
# generates an unstructured grid of cubic line cells, which are perturbed,
...
# Source: generate cubic line cells
cell_type_source = vtkCellTypeSource()
cell_type_source.SetCellType(VTK_CUBIC_LINE)
...
render_window.SetWindowName("celltype cubic line")
