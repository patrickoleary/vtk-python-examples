...
# Render a single vtkParametricBour surface, centered and
...
# Parametric function: define the Bour minimal surface
parametric_fn = vtkParametricBour()
...
render_window.SetWindowName("parametric object bour")
