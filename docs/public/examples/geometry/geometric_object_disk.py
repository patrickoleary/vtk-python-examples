...
# Render a 3D disk using vtkDiskSource. The source produces a polygonal disk
# (annulus) centered at the origin in the XY plane.
...
render_window.SetWindowName("geometric object disk")
