...
# Render a single vtkParametricPluckerConoid surface, centered and
...
# Parametric function: define the Plucker conoid surface
parametric_fn = vtkParametricPluckerConoid()
...
render_window.SetWindowName("parametric object plucker conoid")
