...
# Demonstrate vtkCellTypeSource for the Pyramid cell type. The source
# generates an unstructured grid of pyramid cells, which are perturbed,
...
# Source: generate pyramid cells
cell_type_source = vtkCellTypeSource()
cell_type_source.SetCellType(VTK_PYRAMID)
...
render_window.SetWindowName("celltype pyramid")
