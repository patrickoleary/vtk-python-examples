...
explicit_grid = converter.GetOutput()
explicit_grid.ComputeFacesConnectivityFlagsArray()
explicit_grid.GetCellData().SetActiveScalars("ConnectivityFlags")
connectivity_scalars = explicit_grid.GetCellData().GetArray("ConnectivityFlags")

# Mapper: map the grid to graphics primitives colored by connectivity flags
mapper = vtkDataSetMapper()
mapper.SetInputData(explicit_grid)
mapper.SetColorModeToMapScalars()
mapper.SetScalarRange(connectivity_scalars.GetRange())
...
render_window.SetWindowName("load esgrid")
...
renderer.GetActiveCamera().SetPosition(312452.407650, 7474760.406373, 3507.364723)
renderer.GetActiveCamera().SetFocalPoint(314388.388434, 7481520.509575, -2287.477388)
renderer.GetActiveCamera().SetViewUp(0.089920, 0.633216, 0.768734)
renderer.GetActiveCamera().SetDistance(9111.926908)
renderer.GetActiveCamera().SetClippingRange(595.217338, 19595.429475)
