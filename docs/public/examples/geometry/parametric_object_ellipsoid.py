...
# Render a single vtkParametricEllipsoid surface, centered and
...
# Parametric function: define the ellipsoid surface with custom radii
parametric_fn = vtkParametricEllipsoid()
parametric_fn.SetXRadius(0.5)
parametric_fn.SetYRadius(2.0)
...
render_window.SetWindowName("parametric object ellipsoid")
