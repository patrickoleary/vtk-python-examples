...
# Render a single vtkParametricMobius surface, centered and
...
# Parametric function: define the Mobius strip with custom radius and V range
parametric_fn = vtkParametricMobius()
parametric_fn.SetRadius(2.0)
parametric_fn.SetMinimumV(-0.5)
parametric_fn.SetMaximumV(0.5)
...
render_window.SetWindowName("parametric object mobius")
