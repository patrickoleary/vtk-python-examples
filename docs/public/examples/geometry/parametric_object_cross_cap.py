...
# Render a single vtkParametricCrossCap surface, centered and
...
# Parametric function: define the cross-cap surface
parametric_fn = vtkParametricCrossCap()
...
render_window.SetWindowName("parametric object cross cap")
