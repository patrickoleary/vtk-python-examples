...
# Render a cube Platonic solid with each face colored using a lookup
# table so adjacent faces are visually distinct.
...
# Source: generate cube polygon data (solid type 1)
...
render_window.SetWindowName("platonic solid cube")
