...
# Render an icosahedron Platonic solid with each face colored using a
...
# Source: generate icosahedron polygon data (solid type 3)
source = vtkPlatonicSolidSource()
source.SetSolidType(3)
...
render_window.SetWindowName("platonic solid icosahedron")
