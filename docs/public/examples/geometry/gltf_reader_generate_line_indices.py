...
# Read a glTF file with LINES primitive mode (generated indices) and render.
...
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "PrimitiveModes", "Mesh_PrimitiveMode_LINES.gltf"))
gltf_reader.Update()
...
render_window.SetWindowName("gltf reader generate line indices")
