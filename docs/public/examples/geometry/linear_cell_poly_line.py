...
# Render a single poly line linear cell with vertex-ordering labels and
...
# Cell: Poly Line with 5 points
sf = 2.0
points = vtkPoints()
points.InsertNextPoint(0 / sf, 0.5 / sf, 0)
points.InsertNextPoint(0.5 / sf, 0 / sf, 0)
points.InsertNextPoint(1 / sf, 0.3 / sf, 0)
points.InsertNextPoint(1.5 / sf, 0.4 / sf, 0)
points.InsertNextPoint(2.0 / sf, 0.4 / sf, 0)
...
render_window.SetWindowName("linear cell poly line")
