...
# Demonstrate vtkImprintFilter with various output type permutations:
# target cells, imprinted cells, projected imprint, and imprinted region,
# shown in four renderers with a rotated and translated imprint plane.
...
render_window.SetWindowName("imprint output types")
