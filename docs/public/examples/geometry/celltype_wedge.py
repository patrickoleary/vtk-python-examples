...
# Demonstrate vtkCellTypeSource for the Wedge cell type. The source generates
# an unstructured grid of wedge cells, which are perturbed, shrunk,
...
render_window.SetWindowName("celltype wedge")
