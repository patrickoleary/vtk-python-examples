...
# Render a single pyramid linear cell with vertex-ordering labels,
...
sf = 2.0
points = vtkPoints()
points.InsertNextPoint(1.0 / sf, 0 / sf, -1.0 / sf)
points.InsertNextPoint(-1.0 / sf, 0 / sf, -1.0 / sf)
points.InsertNextPoint(-1.0 / sf, 0 / sf, 1.0 / sf)
points.InsertNextPoint(1.0 / sf, 0 / sf, 1.0 / sf)
points.InsertNextPoint(0.0 / sf, 2.0 / sf, 0 / sf)
cell = vtkPyramid()
for i in range(5):
...
render_window.SetWindowName("linear cell pyramid")
