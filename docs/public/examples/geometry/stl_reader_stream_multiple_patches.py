...
# Read a multi-patch STL file via vtkFileResourceStream and render.
...
file_stream.Open(os.path.join(data_dir, "multiple_patches.stl"))
...
render_window.SetWindowName("stl reader stream multiple patches")
