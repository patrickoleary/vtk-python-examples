...
# Read a glTF file with TRIANGLE_FAN primitive mode (read indices) and render.
...
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "PrimitiveModes", "Mesh_PrimitiveMode_TRIANGLE_FAN_2.gltf"))
gltf_reader.Update()
...
render_window.SetWindowName("gltf reader read triangle fan indices")
