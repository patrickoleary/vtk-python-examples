...
# Demonstrate vtkCollisionDetectionFilter in FirstContact mode by creating
# two spheres, translating one toward the other, detecting the first
# collision, and rendering the wireframe spheres with contact lines.
...
# Collision detection filter — FirstContact mode
...
render_window.SetWindowName("collision detection first contact")
