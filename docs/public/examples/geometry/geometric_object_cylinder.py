...
# Render a 3D cylinder using vtkCylinderSource. The source produces a
# polygonal cylinder centered at the origin with its axis along the Y axis.
...
# Source: generate cylinder geometry
...
render_window.SetWindowName("geometric object cylinder")
