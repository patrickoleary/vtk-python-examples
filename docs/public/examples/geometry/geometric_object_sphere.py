...
# Render a 3D sphere using vtkSphereSource. The source produces a polygonal
...
# Source: generate sphere geometry
...
render_window.SetWindowName("geometric object sphere")
