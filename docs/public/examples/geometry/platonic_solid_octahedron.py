...
# Render an octahedron Platonic solid with each face colored using a
...
# Source: generate octahedron polygon data (solid type 2)
source = vtkPlatonicSolidSource()
source.SetSolidType(2)
...
render_window.SetWindowName("platonic solid octahedron")
