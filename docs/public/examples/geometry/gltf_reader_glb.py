...
# Read a GLB binary glTF file and render geometry.
...
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "Triangle", "Triangle.glb"))
gltf_reader.Update()
...
gltf_actor.GetProperty().SetColor(0.2, 0.8, 0.5)
...
render_window.SetWindowName("gltf reader glb")
