...
# Render a single vtkParametricEnneper surface, centered and
...
# Parametric function: define the Enneper minimal surface
parametric_fn = vtkParametricEnneper()
...
render_window.SetWindowName("parametric object enneper")
