...
# Render a tetrahedron Platonic solid with each face colored using a
...
# Source: generate tetrahedron polygon data (solid type 0)
source = vtkPlatonicSolidSource()
source.SetSolidType(0)
...
render_window.SetWindowName("platonic solid tetrahedron")
