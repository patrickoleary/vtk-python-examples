...
# Read a glTF file with TRIANGLE_STRIP primitive mode (generated indices) and render.
...
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "PrimitiveModes", "Mesh_PrimitiveMode_TRIANGLE_STRIP.gltf"))
gltf_reader.Update()
...
render_window.SetWindowName("gltf reader generate triangle strip indices")
