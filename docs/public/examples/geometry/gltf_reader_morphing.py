...
# Read an animated morph cube glTF file and render at a specific time step.
...
# Read animated morph cube glTF file
step = 200
gltf_reader = vtkGLTFReader()
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "AnimatedMorphCube", "AnimatedMorphCube.gltf"))
...
render_window.SetWindowName("gltf reader morphing")
