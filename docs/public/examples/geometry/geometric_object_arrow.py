...
# Render a 3D arrow using vtkArrowSource. The source produces a polygonal
# arrow pointing along the positive X axis.
...
# Source: generate arrow geometry
...
render_window.SetWindowName("geometric object arrow")
