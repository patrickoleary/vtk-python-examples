...
# Render a single hexagonal prism linear cell with vertex-ordering labels,
# gold sphere glyphs at the vertices, and a translucent plinth.
...
# Cell: Hexagonal Prism with explicitly placed points
cell = vtkHexagonalPrism()
scale = 4.0
cell.GetPoints().SetPoint(0, 11 / scale, 10 / scale, 10 / scale)
cell.GetPoints().SetPoint(1, 13 / scale, 10 / scale, 10 / scale)
cell.GetPoints().SetPoint(2, 14 / scale, 12 / scale, 10 / scale)
cell.GetPoints().SetPoint(3, 13 / scale, 14 / scale, 10 / scale)
cell.GetPoints().SetPoint(4, 11 / scale, 14 / scale, 10 / scale)
cell.GetPoints().SetPoint(5, 10 / scale, 12 / scale, 10 / scale)
cell.GetPoints().SetPoint(6, 11 / scale, 10 / scale, 14 / scale)
cell.GetPoints().SetPoint(7, 13 / scale, 10 / scale, 14 / scale)
cell.GetPoints().SetPoint(8, 14 / scale, 12 / scale, 14 / scale)
cell.GetPoints().SetPoint(9, 13 / scale, 14 / scale, 14 / scale)
cell.GetPoints().SetPoint(10, 11 / scale, 14 / scale, 14 / scale)
cell.GetPoints().SetPoint(11, 10 / scale, 12 / scale, 14 / scale)
for i in range(12):
...
# Translucent plinth beneath the 3D cell
nb = grid.GetBounds()
...
render_window.SetWindowName("linear cell hexagonal prism")
