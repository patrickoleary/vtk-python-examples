...
# Interactive demo of a super-toroid parametric surface.  Two sliders
...
# Source: parametric super-toroid surface
...
render_window.SetWindowName("parametric super toroid app")
