...
# Render a single vtkParametricConicSpiral surface, centered and
...
# Parametric function: define the conic spiral surface
parametric_fn = vtkParametricConicSpiral()
...
render_window.SetWindowName("parametric object conic spiral")
