#!/usr/bin/env python
# Demonstrate Lagrange tetrahedron interpolation, intersection, and clipping for orders 1-7.
...
n_points_for_order = [-1, 4, 10, 20, 35, 56, 84, 15]
center = [0.5, 0.5, 0.0]

# Order 1 (4 points).
cell_order_1 = vtkLagrangeTetra()
cell_order_1.GetPointIds().SetNumberOfIds(4)
cell_order_1.GetPoints().SetNumberOfPoints(4)
...
# Order 2 (10 points).
cell_order_2 = vtkLagrangeTetra()
cell_order_2.GetPointIds().SetNumberOfIds(10)
cell_order_2.GetPoints().SetNumberOfPoints(10)
...
radiant_2.SetNumberOfTuples(10)
max_dist_2 = 0.0
for i in range(10):
...
# Order 3 (20 points).
cell_order_3 = vtkLagrangeTetra()
cell_order_3.GetPointIds().SetNumberOfIds(20)
cell_order_3.GetPoints().SetNumberOfPoints(20)
...
radiant_3.SetNumberOfTuples(20)
max_dist_3 = 0.0
for i in range(20):
...
# Order 4 (35 points).
cell_order_4 = vtkLagrangeTetra()
cell_order_4.GetPointIds().SetNumberOfIds(35)
cell_order_4.GetPoints().SetNumberOfPoints(35)
...
radiant_4.SetNumberOfTuples(35)
max_dist_4 = 0.0
for i in range(35):
...
# Order 5 (56 points).
cell_order_5 = vtkLagrangeTetra()
cell_order_5.GetPointIds().SetNumberOfIds(56)
cell_order_5.GetPoints().SetNumberOfPoints(56)
...
radiant_5.SetNumberOfTuples(56)
max_dist_5 = 0.0
for i in range(56):
...
# Order 6 (84 points).
cell_order_6 = vtkLagrangeTetra()
cell_order_6.GetPointIds().SetNumberOfIds(84)
cell_order_6.GetPoints().SetNumberOfPoints(84)
...
radiant_6.SetNumberOfTuples(84)
max_dist_6 = 0.0
for i in range(84):
...
# Order 7 (15 points).
cell_order_7 = vtkLagrangeTetra()
cell_order_7.GetPointIds().SetNumberOfIds(15)
cell_order_7.GetPoints().SetNumberOfPoints(15)
...
radiant_7.SetNumberOfTuples(15)
max_dist_7 = 0.0
for i in range(15):
...
# Mappers, actors, renderers for intersection viewports (0, 2, 4, 6, 8, 10, 12).
...
render_window.SetWindowName("lagrange tetra")
