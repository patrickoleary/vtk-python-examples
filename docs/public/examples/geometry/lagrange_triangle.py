#!/usr/bin/env python
# Demonstrate Lagrange triangle interpolation, intersection, and clipping for orders 1-7.
...
# Order 1 (3 points).
cell_order_1 = vtkLagrangeTriangle()
cell_order_1.GetPointIds().SetNumberOfIds(3)
cell_order_1.GetPoints().SetNumberOfPoints(3)
...
for i in range(1000):
    ...
    for pt in [p0, p1]:
        ...
        sequence_1.Next()
        pt[0] = 1.2 * math.cos(theta) * math.sin(phi) + center[0]
        pt[1] = 1.2 * math.sin(theta) * math.sin(phi) + center[1]
        pt[2] = 1.2 * math.cos(phi) + center[2]
    t_val = reference(0.0)
    x = [0.0, 0.0, 0.0]
    pcoords = [0.0, 0.0, 0.0]
    sub_id = reference(0)
...
# Order 2 (6 points).
cell_order_2 = vtkLagrangeTriangle()
cell_order_2.GetPointIds().SetNumberOfIds(6)
cell_order_2.GetPoints().SetNumberOfPoints(6)
...
# Order 3 (10 points).
cell_order_3 = vtkLagrangeTriangle()
cell_order_3.GetPointIds().SetNumberOfIds(10)
cell_order_3.GetPoints().SetNumberOfPoints(10)
...
radiant_3.SetNumberOfTuples(10)
max_dist_3 = 0.0
for i in range(10):
...
# Order 4 (15 points).
cell_order_4 = vtkLagrangeTriangle()
cell_order_4.GetPointIds().SetNumberOfIds(15)
cell_order_4.GetPoints().SetNumberOfPoints(15)
...
radiant_4.SetNumberOfTuples(15)
max_dist_4 = 0.0
for i in range(15):
...
# Order 5 (21 points).
cell_order_5 = vtkLagrangeTriangle()
cell_order_5.GetPointIds().SetNumberOfIds(21)
cell_order_5.GetPoints().SetNumberOfPoints(21)
...
radiant_5.SetNumberOfTuples(21)
max_dist_5 = 0.0
for i in range(21):
...
# Order 6 (28 points).
cell_order_6 = vtkLagrangeTriangle()
cell_order_6.GetPointIds().SetNumberOfIds(28)
cell_order_6.GetPoints().SetNumberOfPoints(28)
...
radiant_6.SetNumberOfTuples(28)
max_dist_6 = 0.0
for i in range(28):
...
# Order 7 (7 points).
cell_order_7 = vtkLagrangeTriangle()
cell_order_7.GetPointIds().SetNumberOfIds(7)
cell_order_7.GetPoints().SetNumberOfPoints(7)
...
render_window.SetWindowName("lagrange triangle")

# Scene: set camera for intersection viewports.
renderer_0.GetActiveCamera().SetPosition(0, 0, 2)
renderer_0.GetActiveCamera().SetFocalPoint(center[0], center[1], center[2])
renderer_2.GetActiveCamera().SetPosition(0, 0, 2)
renderer_2.GetActiveCamera().SetFocalPoint(center[0], center[1], center[2])
renderer_4.GetActiveCamera().SetPosition(0, 0, 2)
renderer_4.GetActiveCamera().SetFocalPoint(center[0], center[1], center[2])
renderer_6.GetActiveCamera().SetPosition(0, 0, 2)
renderer_6.GetActiveCamera().SetFocalPoint(center[0], center[1], center[2])
renderer_8.GetActiveCamera().SetPosition(0, 0, 2)
renderer_8.GetActiveCamera().SetFocalPoint(center[0], center[1], center[2])
renderer_10.GetActiveCamera().SetPosition(0, 0, 2)
renderer_10.GetActiveCamera().SetFocalPoint(center[0], center[1], center[2])
renderer_12.GetActiveCamera().SetPosition(0, 0, 2)
renderer_12.GetActiveCamera().SetFocalPoint(center[0], center[1], center[2])

# Scene: set camera for clip viewports.
renderer_1.GetActiveCamera().SetPosition(0.5 * max_dist_1, 0.5 * max_dist_1, -2.0 * max_dist_1)
renderer_1.GetActiveCamera().SetFocalPoint(0.5 * max_dist_1, 0.5 * max_dist_1, 0)
renderer_3.GetActiveCamera().SetPosition(0.5 * max_dist_2, 0.5 * max_dist_2, -2.0 * max_dist_2)
renderer_3.GetActiveCamera().SetFocalPoint(0.5 * max_dist_2, 0.5 * max_dist_2, 0)
renderer_5.GetActiveCamera().SetPosition(0.5 * max_dist_3, 0.5 * max_dist_3, -2.0 * max_dist_3)
renderer_5.GetActiveCamera().SetFocalPoint(0.5 * max_dist_3, 0.5 * max_dist_3, 0)
renderer_7.GetActiveCamera().SetPosition(0.5 * max_dist_4, 0.5 * max_dist_4, -2.0 * max_dist_4)
renderer_7.GetActiveCamera().SetFocalPoint(0.5 * max_dist_4, 0.5 * max_dist_4, 0)
renderer_9.GetActiveCamera().SetPosition(0.5 * max_dist_5, 0.5 * max_dist_5, -2.0 * max_dist_5)
renderer_9.GetActiveCamera().SetFocalPoint(0.5 * max_dist_5, 0.5 * max_dist_5, 0)
renderer_11.GetActiveCamera().SetPosition(0.5 * max_dist_6, 0.5 * max_dist_6, -2.0 * max_dist_6)
renderer_11.GetActiveCamera().SetFocalPoint(0.5 * max_dist_6, 0.5 * max_dist_6, 0)
renderer_13.GetActiveCamera().SetPosition(0.5 * max_dist_7, 0.5 * max_dist_7, -2.0 * max_dist_7)
renderer_13.GetActiveCamera().SetFocalPoint(0.5 * max_dist_7, 0.5 * max_dist_7, 0)
