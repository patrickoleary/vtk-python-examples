...
# Render a single pentagonal prism linear cell with vertex-ordering labels,
...
# Cell: Pentagonal Prism with explicitly placed points
cell = vtkPentagonalPrism()
scale = 4.0
...
cell.GetPoints().SetPoint(3, 12 / scale, 14 / scale, 10 / scale)
cell.GetPoints().SetPoint(4, 10 / scale, 12 / scale, 10 / scale)
cell.GetPoints().SetPoint(5, 11 / scale, 10 / scale, 14 / scale)
cell.GetPoints().SetPoint(6, 13 / scale, 10 / scale, 14 / scale)
cell.GetPoints().SetPoint(7, 14 / scale, 12 / scale, 14 / scale)
cell.GetPoints().SetPoint(8, 12 / scale, 14 / scale, 14 / scale)
cell.GetPoints().SetPoint(9, 10 / scale, 12 / scale, 14 / scale)
for i in range(10):
...
render_window.SetWindowName("linear cell pentagonal prism")
