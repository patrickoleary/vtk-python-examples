...
# Render a cloud of random points using vtkPointSource with a tomato back-face.
...
# Source: generate random point cloud data
...
render_window.SetWindowName("source object point source")
