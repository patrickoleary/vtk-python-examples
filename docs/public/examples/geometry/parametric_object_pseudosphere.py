...
# Render a single vtkParametricPseudosphere surface, centered and
...
# Parametric function: define the pseudosphere surface
parametric_fn = vtkParametricPseudosphere()
...
render_window.SetWindowName("parametric object pseudosphere")
