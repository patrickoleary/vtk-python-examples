...
# Render a single vtkParametricSuperToroid surface, centered and
...
# Parametric function: define the super-toroid surface with custom exponents
parametric_fn = vtkParametricSuperToroid()
parametric_fn.SetN1(0.5)
parametric_fn.SetN2(3.0)
...
render_window.SetWindowName("parametric object super toroid")
