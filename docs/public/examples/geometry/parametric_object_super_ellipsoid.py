...
# Render a single vtkParametricSuperEllipsoid surface, centered and
...
# Parametric function: define the super-ellipsoid surface with custom exponents
parametric_fn = vtkParametricSuperEllipsoid()
parametric_fn.SetN1(0.5)
parametric_fn.SetN2(0.4)
...
render_window.SetWindowName("parametric object super ellipsoid")
