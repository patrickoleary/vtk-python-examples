...
# Demonstrate vtkCellTypeSource for the Quadratic Quad cell type. The source
# generates an unstructured grid of quadratic quad cells, which are perturbed,
...
# Source: generate quadratic quad cells
cell_type_source = vtkCellTypeSource()
cell_type_source.SetCellType(VTK_QUADRATIC_QUAD)
...
render_window.SetWindowName("celltype quadratic quad")
