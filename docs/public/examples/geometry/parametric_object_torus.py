...
# Render a single vtkParametricTorus surface, centered and
...
# Parametric function: define the torus surface
parametric_fn = vtkParametricTorus()
...
render_window.SetWindowName("parametric object torus")
