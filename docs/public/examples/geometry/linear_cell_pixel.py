...
# Render a single pixel linear cell with vertex-ordering labels and
...
# Cell: Pixel (note: pixel uses i,j ordering: 0,1 = x-axis, 2,3 = +y row)
cell = vtkPixel()
...
render_window.SetWindowName("linear cell pixel")
