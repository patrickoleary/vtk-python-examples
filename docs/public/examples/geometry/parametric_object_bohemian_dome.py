...
# Render a single vtkParametricBohemianDome surface, centered and
...
# Parametric function: define the Bohemian Dome surface with custom parameters
parametric_fn = vtkParametricBohemianDome()
parametric_fn.SetA(5.0)
parametric_fn.SetB(1.0)
parametric_fn.SetC(2.0)
...
render_window.SetWindowName("parametric object bohemian dome")
