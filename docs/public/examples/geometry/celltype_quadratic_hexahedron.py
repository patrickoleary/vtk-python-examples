...
# Demonstrate vtkCellTypeSource for the Quadratic Hexahedron cell type. The
# source generates an unstructured grid of quadratic hexahedral cells, which
# are perturbed, shrunk, tessellated, and color-mapped by cell ID.
...
# Source: generate quadratic hexahedral cells
cell_type_source = vtkCellTypeSource()
cell_type_source.SetCellType(VTK_QUADRATIC_HEXAHEDRON)
...
render_window.SetWindowName("celltype quadratic hexahedron")
