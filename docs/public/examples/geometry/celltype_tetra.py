...
# Demonstrate vtkCellTypeSource for the Tetra cell type. The source generates
# an unstructured grid of tetrahedral cells, which are perturbed, shrunk,
...
# Source: generate tetrahedral cells
...
render_window.SetWindowName("celltype tetra")
