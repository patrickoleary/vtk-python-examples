...
# Read a glTF file with POINTS primitive mode (generated indices) and render.
...
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "PrimitiveModes", "Mesh_PrimitiveMode_POINTS.gltf"))
gltf_reader.Update()
...
render_window.SetWindowName("gltf reader generate point indices")
