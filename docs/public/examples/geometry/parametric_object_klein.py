...
# Render a single vtkParametricKlein surface, centered and
...
# Parametric function: define the Klein bottle surface
parametric_fn = vtkParametricKlein()
...
render_window.SetWindowName("parametric object klein")
