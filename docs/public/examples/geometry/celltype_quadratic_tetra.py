...
# Demonstrate vtkCellTypeSource for the Quadratic Tetra cell type. The source
# generates an unstructured grid of quadratic tetrahedral cells, which are
...
# Source: generate quadratic tetrahedral cells
source = vtkCellTypeSource()
source.SetCellType(VTK_QUADRATIC_TETRA)
source.Update()
...
render_window.SetWindowName("celltype quadratic tetra")
