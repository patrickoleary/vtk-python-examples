...
# Read a glTF file with TRIANGLE_FAN primitive mode (generated indices) and render.
...
gltf_reader.SetFileName(os.path.join(data_dir, "glTF", "PrimitiveModes", "Mesh_PrimitiveMode_TRIANGLE_FAN.gltf"))
gltf_reader.Update()
...
gltf_actor.GetProperty().SetColor(0.8, 0.4, 0.2)
...
render_window.SetWindowName("gltf reader generate triangle fan indices")
