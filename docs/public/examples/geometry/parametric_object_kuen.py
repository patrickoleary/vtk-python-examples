...
# Render a single vtkParametricKuen surface, centered and
...
# Parametric function: define the Kuen surface with custom DeltaV0
parametric_fn = vtkParametricKuen()
parametric_fn.SetDeltaV0(0.001)
...
render_window.SetWindowName("parametric object kuen")
