...
# Demonstrate vtkCellTypeSource for the Hexahedron cell type. The source
# generates an unstructured grid of hexahedral cells, which are perturbed,
...
# Source: generate hexahedral cells
cell_type_source = vtkCellTypeSource()
cell_type_source.SetCellType(VTK_HEXAHEDRON)
...
render_window.SetWindowName("celltype hexahedron")
