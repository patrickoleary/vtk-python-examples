...
# Create a hexahedron, write it to an XML VTK unstructured grid
# (.vtu) file using vtkXMLDataSetWriter, read it back, and render
...
vtu_path = os.path.join(tempfile.gettempdir(), "WriteXMLUnstructuredGrid.vtu")
...
# Writer: save to XML unstructured grid file
...
render_window.SetWindowName("write xml unstructuredgrid")
