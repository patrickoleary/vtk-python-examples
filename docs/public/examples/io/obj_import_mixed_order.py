...
# Import OBJ with mixed ordering and render.
...
obj_importer.SetFileName(os.path.join(input_dir, "boxes_2.obj"))
...
render_window.SetWindowName("obj import mixed order")
