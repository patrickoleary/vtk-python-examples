...
for i in range(output.GetNumberOfCells()):
    cell_type_id = output.GetCellType(i)
    cell_type_name = vtkCellTypeUtilities.GetClassNameFromTypeId(cell_type_id)
...
render_window.SetWindowName("read legacy unstructuredgrid")
