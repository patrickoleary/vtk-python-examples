...
# Import a glTF file with default texture sampler settings and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "texture-sampler-defaults.gltf"))
...
render_window.SetWindowName("gltf importer texture sampler defaults")
