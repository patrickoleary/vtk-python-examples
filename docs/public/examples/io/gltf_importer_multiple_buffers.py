...
# Import a glTF GLB file with multiple buffers (world) and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "world.glb"))
...
render_window.SetWindowName("gltf importer multiple buffers")
