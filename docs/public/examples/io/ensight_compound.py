...
# Read EnSight compound (SOS) file and render pointScalars.
...
# Read EnSight compound file
ensight_reader = vtkEnSightMasterServerReader()
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "elements.sos"))
ensight_reader.SetCurrentPiece(0)
...
composite_mapper.ColorByArrayComponent("pointScalars", 0)
composite_mapper.SetScalarRange(0, 112)
...
render_window.SetWindowName("ensight compound")
