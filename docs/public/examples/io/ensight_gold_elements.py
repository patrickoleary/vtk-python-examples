...
# Read EnSight Gold elements case file and render pointScalars.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "elements.case"))
...
render_window.SetWindowName("ensight gold elements")
