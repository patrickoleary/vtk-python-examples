...
# Read EnSight blow3 binary case file and render displacement field.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "blow3_bin.case"))
...
render_window.SetWindowName("ensight blow tensor binary")
