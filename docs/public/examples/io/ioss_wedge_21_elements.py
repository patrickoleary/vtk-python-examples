...
# Read a Genesis file with Wedge21 elements and render the surface.
...
ioss_reader.SetFileName(os.path.join(data_dir, "wedge21.g"))
ioss_reader.Update()
...
render_window.SetWindowName("ioss wedge 21 elements")
