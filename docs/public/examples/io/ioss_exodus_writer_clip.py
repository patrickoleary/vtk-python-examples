...
# Read an Exodus file, clip with TableBasedClipDataSet, write to IOSS, read back, and render.
...
output_file = os.path.join(temp_dir, "clip.ex2")
...
render_window.SetWindowName("ioss exodus writer clip")
