...
# Read a 15-node tetrahedron Exodus file and render the surface.
...
exodus_reader.SetFileName(os.path.join(data_dir, "tetra15.g"))
...
render_window.SetWindowName("exodus tetra 15 node")
