...
# Import a glTF file with URI-referenced textures (Lantern) and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "Lantern", "Lantern.gltf"))
...
render_window.SetWindowName("gltf importer uri texture")
