...
# Import a non-binary glTF file (Cameras) via vtkFileResourceStream and render.
...
file_stream.Open(os.path.join(data_dir, "glTF", "Cameras", "Cameras.gltf"))
...
render_window.SetWindowName("gltf importer non binary stream")
