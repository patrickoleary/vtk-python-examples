...
# Read EnSight blow2 ASCII case file and render displacement field.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "blow2_ascii.case"))
...
render_window.SetWindowName("ensight blow vector ascii")
