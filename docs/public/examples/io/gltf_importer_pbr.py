...
# Import a glTF GLB file (WaterBottle) with PBR materials and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "WaterBottle", "WaterBottle.glb"))
...
render_window.SetWindowName("gltf importer pbr")
