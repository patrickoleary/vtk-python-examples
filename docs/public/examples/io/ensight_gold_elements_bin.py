...
# Read EnSight Gold binary elements case file with time step and render pointTensors.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "elements-bin.case"))
...
render_window.SetWindowName("ensight gold elements bin")
