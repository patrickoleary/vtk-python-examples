...
# Import a glTF file with cameras, apply azimuth and elevation, and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "Cameras", "Cameras.gltf"))
...
render_window.SetWindowName("gltf importer camera move")
