...
# Read EnSight blow5 ASCII case file and render displacement field.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "blow5_ascii.case"))
...
render_window.SetWindowName("ensight blow part ascii")
