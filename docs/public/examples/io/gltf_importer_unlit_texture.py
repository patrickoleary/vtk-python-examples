...
# Import a glTF GLB file with unlit texture and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "unlit-texture.glb"))
...
render_window.SetWindowName("gltf importer unlit texture")
