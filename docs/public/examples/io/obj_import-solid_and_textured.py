...
# Import OBJ with solid and textured geometry and render.
...
obj_importer.SetFileNameMTL(os.path.join(input_dir, "cube-scene.mtl"))
...
render_window.SetWindowName("obj import-solid and textured")
