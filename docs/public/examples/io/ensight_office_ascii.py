...
# Read EnSight office ASCII case file, compute streamlines with cone glyphs.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "office_ascii.case"))
...
render_window.SetWindowName("ensight office ascii")
