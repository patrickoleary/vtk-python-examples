...
# Read EnSight blow4 binary case file and render displacement field.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "blow4_bin.case"))
ensight_reader.SetTimeValue(1.0)
...
render_window.SetWindowName("ensight blow time series binary")
