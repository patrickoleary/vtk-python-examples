...
# Import a glTF GLB file with alpha/opacity and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "alpha.glb"))
...
render_window.SetWindowName("gltf importer opacity")
