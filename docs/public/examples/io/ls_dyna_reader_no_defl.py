...
# Read an LS-DYNA file with no deflection data and render.
...
lsdyna_reader.SetFileName(os.path.join(data_dir, "bug_14713", "bug_14713.d3plot"))
...
render_window.SetWindowName("ls dyna reader no defl")
