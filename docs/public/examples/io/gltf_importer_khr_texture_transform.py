...
# Import a glTF GLB file with KHR_texture_transform extension and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "TextureTransform.glb"))
...
render_window.SetWindowName("gltf importer khr texture transform")
