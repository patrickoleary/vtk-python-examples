...
# Import a glTF file, export as OBJ, then re-import the OBJ and render.
...
obj_exporter.SetOBJFileComment("Converted by ImportExport from Avocado.glb")
obj_exporter.SetMTLFileComment("Converted by ImportExport from Avocado.glb")
...
render_window.SetWindowName("import glft export obj")
