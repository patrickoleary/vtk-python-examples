...
# Read a NetCDF CF file with 2D bounds, render cartesian and spherical coordinate views side by side.
...
reader_spherical.SetFileName(os.path.join(data_dir, "sampleCurveGrid4.nc"))
...
render_window.SetWindowName("netcdf cf2d bounds x array")
