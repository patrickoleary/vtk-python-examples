...
# Read EnSight ironProt binary case file, contour at 200, and render.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "ironProt_bin.case"))
...
render_window.SetWindowName("ensight iron prot bin")
