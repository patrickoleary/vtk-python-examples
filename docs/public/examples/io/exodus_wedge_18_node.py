...
# Read an 18-node wedge Exodus file and render the surface.
...
exodus_reader.SetFileName(os.path.join(data_dir, "wedge18.e"))
...
render_window.SetWindowName("exodus wedge 18 node")
