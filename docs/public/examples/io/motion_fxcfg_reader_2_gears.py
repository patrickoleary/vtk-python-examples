...
# Read a MotionFX CFG file for a 2-gear animation and render at the middle time step.
...
motionfx_reader.SetFileName(os.path.join(data_dir, "2_gears", "rotate_motion.cfg"))
...
render_window.SetWindowName("motion fxcfg reader 2 gears")
