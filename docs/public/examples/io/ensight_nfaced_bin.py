...
# Read EnSight nfaced binary case file and render Pressure field.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "TEST_bin.case"))
...
render_window.SetWindowName("ensight nfaced bin")
