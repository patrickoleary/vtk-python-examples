...
# Import a glTF GLB file (TexturedMonkey) and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "TexturedMonkey.glb"))
...
render_window.SetWindowName("gltf importer tex coord")
