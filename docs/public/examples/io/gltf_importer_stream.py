...
# Import a glTF GLB file (Avocado) via vtkFileResourceStream and render.
...
file_stream.Open(os.path.join(data_dir, "glTF", "Avocado", "Avocado.glb"))
...
render_window.SetWindowName("gltf importer stream")
