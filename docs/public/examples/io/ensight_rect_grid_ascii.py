...
# Read EnSight RectGrid ASCII case with plane extraction, contour, streamlines, and tube filter.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "RectGrid_ascii.case"))
...
render_window.SetWindowName("ensight rect grid ascii")
