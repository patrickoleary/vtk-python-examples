...
# Read EnSight blow2 binary case file and render displacement field.
...
ensight_reader.SetCaseFileName(os.path.join(data_dir, "EnSight", "blow2_bin.case"))
...
render_window.SetWindowName("ensight blow vector binary")
