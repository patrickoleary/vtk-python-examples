...
# Import a glTF GLB file with unlit materials and render.
...
gltf_importer.SetFileName(os.path.join(data_dir, "glTF", "UnlitTest", "UnlitTest.glb"))
...
render_window.SetWindowName("gltf importer unlit")
