...
# Render a sphere, capture the render window to a PNG image file
# using vtkPNGWriter, then display the rendered scene.
...
png_path = os.path.join(tempfile.gettempdir(), "WriteImagePNG.png")
...
render_window.SetWindowName("write image png")
render_window.SetMultiSamples(0)
render_window.SetSize(640, 480)
render_window.Render()

# Writer: capture the render window to a PNG file
