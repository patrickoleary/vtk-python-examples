...
# Test the unoptimized code path in vtkImageReslice with different interpolation modes.
...
# Linear with both axes and transform, optimization off
reslice4 = vtkImageReslice()
reslice4.SetInputConnection(reader.GetOutputPort())
reslice4.OptimizationOff()
reslice4.SetResliceAxes(matrix)
...
render_window.SetWindowName("reslice optimization off")
