...
# Demonstrate vtkProgrammableDataObjectSource to manually parse financial
# data from a text file, then visualize with Gaussian splatting isosurfaces
# and labeled axes. Image should match financialField.
...
render_window.SetWindowName("financial field programmable")
