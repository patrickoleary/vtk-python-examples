...
# vtkRuledSurfaceFilter in Resample mode with backward integration.
...
# Ruled surface in Resample mode
...
scalar_surface.SetRuledModeToResample()
scalar_surface.SetResolution(100, 1)
...
render_window.SetWindowName("stream surface backward")
