...
# Continuous morphological close (dilate then erode) on a 2D medical image.
...
image_actor.GetMapper().SetInputConnection(erode.GetOutputPort())
...
render_window.SetWindowName("continuous close2d")
