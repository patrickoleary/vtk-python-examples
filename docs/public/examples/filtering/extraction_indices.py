...
# Demonstrate vtkExtractSelection with INDICES selection type
...
# --- INDICES on cells: preserve topology ---
...
# --- INDICES on points: preserve topology ---
selection_node.GetProperties().Set(vtkSelectionNode.INVERSE(), 0)
...
# --- INDICES on points: preserve topology + containing cells ---
selection_node.GetProperties().Set(vtkSelectionNode.CONTAINING_CELLS(), 1)
extract_selection.Update()
...
render_window.SetWindowName("extraction indices")
