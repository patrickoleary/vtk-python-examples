#!/usr/bin/env python
# Demonstrate a parallel coordinates chart with double arrays at extreme scales.
...
for i in range(num_points):
    ...
    table.SetValue(i, 1, math.cos(i * inc) * 1.0e-82)
    table.SetValue(i, 2, math.sin(i * inc) * 1.0e+89)
...
render_window.SetWindowName("parallel coordinates double")
