...
# Demonstrate vtkDataSetGradientPrecompute followed by vtkDataSetGradient
# by computing cell gradients on an unstructured grid and visualizing
# them as arrow glyphs.
...
# Precompute gradient weights
precompute = vtkDataSetGradientPrecompute()
precompute.SetInputConnection(reader.GetOutputPort())

# Compute gradient for each cell
gradient = vtkDataSetGradient()
gradient.SetInputConnection(precompute.GetOutputPort())
...
render_window.SetWindowName("dataset gradient precompute")
