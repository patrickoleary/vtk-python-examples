#!/usr/bin/env python
# Demonstrate vtkContextArea with a fixed rectangle using DEM data and contours.
...
# Set up the context area with a fixed rectangle.
area = vtkContextArea()
x_min, x_max, y_min, y_max = bounds[0], bounds[1], bounds[2], bounds[3]
area.SetDrawAreaBounds(vtkRectd(x_min, y_min, x_max - x_min, y_max - y_min))
...
render_window.SetWindowName("context area fixed rect")
