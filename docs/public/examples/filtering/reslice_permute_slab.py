...
# Test vtkImageReslice with different slab modes and axis permutations.
...
# Mean slab with trapezoid integration
...
# Min slab with cubic interpolation
...
render_window.SetWindowName("reslice permute slab")
