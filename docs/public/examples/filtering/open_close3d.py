...
# Apply morphological open-close operation to a thresholded medical image.
...
image_actor.GetMapper().SetInputConnection(my_close.GetOutputPort())
...
render_window.SetWindowName("open close3d")
