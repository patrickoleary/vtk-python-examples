...
# Demonstrate vtkExtractSelection with LOCATIONS selection type
...
# --- LOCATIONS on cells: preserve topology ---
...
# --- LOCATIONS on points: preserve topology ---
selection_node.GetProperties().Set(vtkSelectionNode.INVERSE(), 0)
...
# --- LOCATIONS on points: preserve topology + containing cells ---
selection_node.GetProperties().Set(vtkSelectionNode.CONTAINING_CELLS(), 1)
extract_selection.Update()
...
render_window.SetWindowName("extraction locations")
