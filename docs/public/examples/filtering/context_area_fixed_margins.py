#!/usr/bin/env python
# Demonstrate vtkContextArea with fixed margins using DEM data and contours.
...
# Set up the context area with fixed margins.
area = vtkContextArea()
...
render_window.SetWindowName("context area fixed margins")
