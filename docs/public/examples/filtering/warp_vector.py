...
# Warp a plane by random vector displacements using vtkWarpVector and
...
for i in range(n_pts):
    vectors.SetTuple3(i, vtk_math.Random(0, 10), vtk_math.Random(0, 10), vtk_math.Random(0, 10))

output.GetPointData().SetVectors(vectors)

# Warp the plane by vector displacements
warp = vtkWarpVector()
...
render_window.SetWindowName("warp vector")
