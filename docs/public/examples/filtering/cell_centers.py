...
cell_centers.SetInputConnection(sphere_source.GetOutputPort())
...
glyph_mapper.SetInputConnection(cell_centers.GetOutputPort())
...
mesh_mapper.SetInputConnection(sphere_source.GetOutputPort())
...
render_window.SetWindowName("cell centers")
