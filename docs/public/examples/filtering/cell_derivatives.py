...
cell_derivatives.SetInputData(structured_grid)
cell_derivatives.SetVectorModeToComputeVorticity()

# Filter: extract surface geometry
geometry_filter = vtkStructuredGridGeometryFilter()
geometry_filter.SetInputConnection(cell_derivatives.GetOutputPort())
...
render_window.SetWindowName("cell derivatives")
