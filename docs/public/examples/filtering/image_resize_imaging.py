...
# Test vtkImageResize with border on/off and interpolation on/off in four viewports.
...
# Viewport 0 (lower-left): border off, interpolate off
resize_0 = vtkImageResize()
resize_0.SetInputConnection(reader.GetOutputPort())
resize_0.SetOutputDimensions(64, 64, 1)
resize_0.BorderOff()
resize_0.InterpolateOff()
...
# Viewport 1 (lower-right): border on, interpolate off
resize_1 = vtkImageResize()
resize_1.SetInputConnection(reader.GetOutputPort())
resize_1.SetOutputDimensions(64, 64, 1)
resize_1.BorderOn()
resize_1.InterpolateOff()
...
# Viewport 2 (upper-left): border off, interpolate on
resize_2 = vtkImageResize()
resize_2.SetInputConnection(reader.GetOutputPort())
resize_2.SetOutputDimensions(64, 64, 1)
resize_2.BorderOff()
resize_2.InterpolateOn()
...
# Viewport 3 (upper-right): border on, interpolate on
resize_3 = vtkImageResize()
resize_3.SetInputConnection(reader.GetOutputPort())
resize_3.SetOutputDimensions(64, 64, 1)
resize_3.BorderOn()
resize_3.InterpolateOn()
...
render_window.SetWindowName("image resize imaging")
