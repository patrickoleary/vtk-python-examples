#!/usr/bin/env python
# Demonstrate line plot selection with plot-based selection method.
...
# Set up a chart with plot-based selection.
chart = vtkChartXY()
...
render_window.SetWindowName("line plot selection method")
