...
# Demonstrate vtkImageCacheFilter on volumetric medical data.
...
image_actor.GetMapper().SetInputConnection(cache.GetOutputPort())
...
render_window.SetWindowName("cache")
