...
# Demonstrate all VTK cell types with individual actors.
...
a_triangle_grid.GetPointData().SetTCoords(triangle_tcoords)
...
a_triangle_strip_grid.GetPointData().SetTCoords(triangle_strip_tcoords)
...
# Properties for triangle and triangle strip
triangle_property = vtkProperty()
triangle_strip_property = vtkProperty()
a_triangle_actor.SetProperty(triangle_property)
a_triangle_strip_actor.SetProperty(triangle_strip_property)

# Texture for triangle
data_dir = os.environ.get("VPE_DATA_DIR", os.path.dirname(os.path.abspath(__file__)))
texture = vtkTexture()
pnm_reader = vtkBMPReader()
pnm_reader.SetFileName(os.path.join(data_dir, "masonry.bmp"))
texture.SetInputConnection(pnm_reader.GetOutputPort())
texture.InterpolateOff()
a_triangle_actor.SetTexture(texture)
...
render_window.SetWindowName("cells")
