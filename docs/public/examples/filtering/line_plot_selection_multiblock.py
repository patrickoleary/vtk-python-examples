#!/usr/bin/env python
# Demonstrate line plot selection with multi-block plot indices.
...
# Set up a chart with selection.
chart = vtkChartXY()
link = vtkAnnotationLink()
chart.SetAnnotationLink(link)
chart.SetActionToButton(vtkChartXY.SELECT_POLYGON, vtkContextMouseEvent.LEFT_BUTTON)
chart.SetSelectionMethod(vtkChartXY.SELECTION_ROWS)

# Add plots with different block indices.
line = chart.AddPlot(vtkChartXY.LINE, 0)
line.SetInputData(table, 0, 1)
line.SetColor(0, 255, 0, 255)
line.SetWidth(1.0)

line = chart.AddPlot(vtkChartXY.LINE, 1)
line.SetInputData(table, 0, 2)
line.SetColor(255, 0, 0, 255)
line.SetWidth(5.0)

line = chart.AddPlot(vtkChartXY.LINE, 2)
...
render_window.SetWindowName("line plot selection multiblock")
