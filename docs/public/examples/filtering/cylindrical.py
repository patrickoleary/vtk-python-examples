#!/usr/bin/env python
# Demonstrate vtkCylindricalTransform mapping a plane to a cylinder with earth texture.
...
# Plane source in cylindrical coordinates.
...
# Cylindrical transform: forward, inverse, forward.
...
render_window.SetWindowName("cylindrical")
