...
# Smooth a noisy sphere using vtkWindowedSincPolyDataFilter with Hamming
# window function, displaying original and smoothed versions in two viewports.
...
# Smooth with windowed sinc filter
...
render_window.SetWindowName("windowed sinc polydata")
