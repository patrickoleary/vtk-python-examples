...
# Test vtkImageReslice with mirror and oblique rotation using different interpolation modes.
...
# Linear at original spacing with mirror
...
render_window.SetWindowName("reslice mirror oblique")
