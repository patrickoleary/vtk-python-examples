...
# Generate a 3D iso-surface on a minimal single-voxel volume using
# vtkFlyingEdges3D to stress boundary conditions.
...
# Create a 2x2x2 image (single voxel) with scalar values
image = vtkImageData()
...
scalars.InsertTuple1(7, 1.0)

# Flying edges 3D contour at zero crossing
...
render_window.SetWindowName("flying edges3d thin slice")
