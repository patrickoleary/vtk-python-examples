...
# Clip an unstructured grid (hexa.vtk) with an axis-aligned box using
...
# Axis-aligned box clip
box_clip = vtkBoxClipDataSet()
box_clip.SetInputConnection(reader.GetOutputPort())
box_clip.SetBoxClip(
    min_box_point[0], max_box_point[0],
    min_box_point[1], max_box_point[1],
    min_box_point[2], max_box_point[2],
)
...
render_window.SetWindowName("box clip point data")
