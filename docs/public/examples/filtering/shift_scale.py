...
# Shift and scale image data to convert precision, then magnify for display.
...
shift_scale.SetOutputScalarTypeToDouble()
...
render_window.SetWindowName("shift scale")
