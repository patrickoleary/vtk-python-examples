...
# Test vtkImageSincInterpolator SlidingWindow on 2D image with various spacings.
...
# Viewport 0 (lower-left): spacing (0.7, 0.8, 1.0)
interpolator_0 = vtkImageSincInterpolator()
interpolator_0.SlidingWindowOn()

reslice_0 = vtkImageReslice()
reslice_0.SetInputConnection(reader.GetOutputPort())
reslice_0.SetInterpolator(interpolator_0)
reslice_0.SetOutputScalarType(VTK_DOUBLE)
reslice_0.SetOutputSpacing(0.7, 0.8, 1.0)
...
# Viewport 1 (lower-right): spacing (1.0, 0.8, 1.0)
interpolator_1 = vtkImageSincInterpolator()
interpolator_1.SlidingWindowOn()

reslice_1 = vtkImageReslice()
reslice_1.SetInputConnection(reader.GetOutputPort())
reslice_1.SetInterpolator(interpolator_1)
reslice_1.SetOutputScalarType(VTK_DOUBLE)
reslice_1.SetOutputSpacing(1.0, 0.8, 1.0)
...
# Viewport 2 (upper-left): spacing (1.7, 1.8, 1.0)
interpolator_2 = vtkImageSincInterpolator()
interpolator_2.SlidingWindowOn()

reslice_2 = vtkImageReslice()
reslice_2.SetInputConnection(reader.GetOutputPort())
reslice_2.SetInterpolator(interpolator_2)
reslice_2.SetOutputScalarType(VTK_DOUBLE)
reslice_2.SetOutputSpacing(1.7, 1.8, 1.0)
...
# Viewport 3 (upper-right): spacing (0.7, 1.0, 1.0)
interpolator_3 = vtkImageSincInterpolator()
interpolator_3.SlidingWindowOn()

reslice_3 = vtkImageReslice()
reslice_3.SetInputConnection(reader.GetOutputPort())
reslice_3.SetInterpolator(interpolator_3)
reslice_3.SetOutputScalarType(VTK_DOUBLE)
reslice_3.SetOutputSpacing(0.7, 1.0, 1.0)
...
render_window.SetWindowName("image interpolate sliding window2d")
