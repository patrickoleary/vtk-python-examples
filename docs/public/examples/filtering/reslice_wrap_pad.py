...
# Test vtkImageReslice with wrap padding and different interpolation modes.
...
# Linear at original spacing with wrap
...
render_window.SetWindowName("reslice wrap pad")
