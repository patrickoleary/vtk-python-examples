...
# Test vtkImageStencilData Clip operation with two box stencils.
...
dummy_image_1 = vtkImageData()
dummy_image_1.SetSpacing(1.0, 1.0, 1.0)
dummy_image_1.SetOrigin(0.0, 0.0, 0.0)
dummy_image_1.SetExtent(8, 32, 8, 32, 0, 0)
dummy_image_1.AllocateScalars(VTK_UNSIGNED_CHAR, 1)

stencil_op_1 = vtkImageStencil()
stencil_op_1.SetInputData(dummy_image_1)
...
dummy_image_2 = vtkImageData()
dummy_image_2.SetSpacing(1.0, 1.0, 1.0)
dummy_image_2.SetOrigin(0.0, 0.0, 0.0)
dummy_image_2.SetExtent(18, 42, 18, 42, 0, 0)
dummy_image_2.AllocateScalars(VTK_UNSIGNED_CHAR, 1)

stencil_op_2 = vtkImageStencil()
stencil_op_2.SetInputData(dummy_image_2)
...
# Add stencils, then clip and re-add
stencil_data_1.Add(stencil_data_2)
stencil_data_1.Clip([15, 35, 15, 35, 0, 0])
stencil_data_2.Clip([35, 39, 35, 39, 0, 0])
stencil_data_1.Add(stencil_data_2)
...
render_window.SetWindowName("clip stencil data")
