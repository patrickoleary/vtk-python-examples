...
# Test vtkAbstractTransform coverage with linear, perspective, and general transforms.
...
# Set up transforms
t_linear = vtkTransform()
t_perspective = vtkPerspectiveTransform()
t_general = vtkGeneralTransform()

# Linear transform
t_linear.Scale(1.2, 1.0, 0.8)
t_linear.RotateX(30)
t_linear.RotateY(10)
t_linear.RotateZ(80)
t_linear.Translate(0.2, 0.3, -0.1)
t_linear.Update()

# Perspective transform
t_perspective.SetInput(t_linear)
t_perspective.SetInput(t_linear.GetInverse())
t_perspective.Scale(2, 2, 2)
# These should cancel
t_perspective.AdjustViewport(-0.5, 0.5, -0.5, 0.5, -1, 1, -1, 1)
t_perspective.AdjustViewport(-1, 1, -1, 1, -0.5, 0.5, -0.5, 0.5)
# Shear transformation
t_perspective.Shear(0.2, 0.3, 0.0)
t_perspective.Update()
# The following 6 operations cancel out
t_perspective.RotateWXYZ(30, 1, 1, 1)
t_perspective.RotateWXYZ(-30, 1, 1, 1)
t_perspective.Scale(2, 2, 2)
t_perspective.Scale(0.5, 0.5, 0.5)
t_perspective.Translate(10, 0.1, 0.3)
t_perspective.Translate(-10, -0.1, -0.3)
t_perspective.Concatenate(t_linear)
# Test push and pop
t_perspective.Push()
t_perspective.RotateX(30)
t_perspective.RotateY(10)
t_perspective.RotateZ(80)
t_perspective.Translate(0.1, -0.2, 0.0)
# Copy of transform
t_new = t_perspective.MakeTransform()
t_new.DeepCopy(t_perspective)
t_perspective.Pop()

# General transform
t_general.SetInput(t_linear)
t_general.SetInput(t_perspective)
t_general.PostMultiply()
t_general.Concatenate(t_new)
t_general.Concatenate(t_new.GetInverse())
t_general.PreMultiply()
# The following 6 operations cancel out
t_general.RotateWXYZ(30, 1, 1, 1)
t_general.RotateWXYZ(-30, 1, 1, 1)
t_general.Scale(2, 2, 2)
t_general.Scale(0.5, 0.5, 0.5)
t_general.Translate(10, 0.1, 0.3)
t_general.Translate(-10, -0.1, -0.3)

# Linear transform and inverse
filter_11 = vtkTransformPolyDataFilter()
filter_11.SetInputConnection(append.GetOutputPort())
filter_11.SetTransform(t_linear)
...
filter_12.SetTransform(t_linear.GetInverse())
...
filter_21.SetTransform(t_perspective)
...
filter_22.SetTransform(t_perspective.GetInverse())
...
filter_32.SetTransform(t_new.GetInverse())
...
filter_42.SetTransform(t_general.GetInverse())
...
render_window.SetWindowName("transform coverage")
