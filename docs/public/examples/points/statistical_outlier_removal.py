...
# Remove statistical outlier points from a point cloud using
# vtkStatisticalOutlierRemoval. Points whose mean distance to
# neighbors deviates significantly from the cloud average are removed.
...
# ---- Right viewport: statistical outliers removed ----
remover = vtkStatisticalOutlierRemoval()
remover.SetInputData(cloud)
remover.SetSampleSize(20)
remover.SetStandardDeviationFactor(1.5)
...
render_window.SetWindowName("statistical outlier removal")
