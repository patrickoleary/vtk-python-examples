...
# Demonstrate vtkPCANormalEstimation with graph traversal orientation by
# extracting points near a sphere surface, estimating normals, and
# rendering with hedgehog normals.
...
# Estimate PCA normals with graph traversal orientation
...
render_window.SetWindowName("pca normals graph traversal")
