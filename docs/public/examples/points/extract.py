...
# Demonstrate vtkExtractPoints by extracting points within a sphere
# implicit function from a bounded random point source, rendering the
# extracted points with a Gaussian mapper and an outline.
...
render_window.SetWindowName("extract")
