#!/usr/bin/env python
# Demonstrate vtkPointCloudWidget with hardware picking on a point cloud.
...
render_window.SetWindowName("pointcloud widget hardware")
...
point_cloud_rep.SetPickingModeToHardware()
