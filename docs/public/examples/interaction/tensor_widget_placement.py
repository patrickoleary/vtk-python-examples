#!/usr/bin/env python
# Demonstrate vtkTensorWidget and vtkTensorRepresentation with tensor placement.
...
render_window.SetWindowName("tensor widget placement")
...
tensor_rep.GetEllipsoidProperty().SetColor(0.4, 0.4, 0.8)
tensor_rep.GetEllipsoidProperty().SetRepresentationToWireframe()
tensor_rep.SetPlaceFactor(1)
tensor_rep.PlaceTensor(tensor, position)
