#!/usr/bin/env python
# Demonstrate vtkImplicitPlaneWidget2 clipping a mace geometry.
...
render_window.SetWindowName("implicit plane clip mace")
...
# Callback updates the clip plane from the widget representation
