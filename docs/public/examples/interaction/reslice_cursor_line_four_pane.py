#!/usr/bin/env python
# Demonstrate vtkResliceCursorWidget with line representation in a four-pane layout.
...
render_window.SetWindowName("reslice cursor line four pane")
...
# Reslice cursor, widgets and representations.
...
reslice_rep_x = vtkResliceCursorLineRepresentation()
...
reslice_rep_y = vtkResliceCursorLineRepresentation()
...
reslice_rep_z = vtkResliceCursorLineRepresentation()
