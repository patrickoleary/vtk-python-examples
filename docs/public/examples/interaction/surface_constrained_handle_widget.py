#!/usr/bin/env python
# Demonstrate a handle widget constrained to lie on a polygonal terrain surface.
...
render_window.SetWindowName("surface constrained handle widget")
...
handle_rep = vtkPointHandleRepresentation3D.SafeDownCast(handle_widget.GetRepresentation())
...
# Disable axis constraint so surface placer is the sole constraint
