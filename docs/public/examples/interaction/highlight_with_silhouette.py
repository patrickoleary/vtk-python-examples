...
# Filter: silhouette pipeline (input data is set dynamically by the interactor)
...
render_window.SetWindowName("highlight with silhouette")
render_window.SetMultiSamples(0)
render_window.SetSize(640, 480)

# Scene: connect silhouette to renderer camera
