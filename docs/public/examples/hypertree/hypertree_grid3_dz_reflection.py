...
# Demonstrate vtkHyperTreeGridAxisReflection on a 3D rectilinear
# HyperTreeGrid reflected along the Z axis.
...
# Create 3D rectilinear HyperTreeGrid
...
render_window.SetWindowName("hypertree grid3 dz reflection")
