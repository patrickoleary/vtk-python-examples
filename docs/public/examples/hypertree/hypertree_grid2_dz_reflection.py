...
# Demonstrate vtkHyperTreeGridAxisReflection on a 2D rectilinear
# HyperTreeGrid reflected along the Y axis (ZY plane orientation).
...
# Create 2D rectilinear HyperTreeGrid (ZY plane)
...
render_window.SetWindowName("hypertree grid2 dz reflection")
...
camera.SetPosition(focal[0] + 6.0, focal[1], focal[2])
