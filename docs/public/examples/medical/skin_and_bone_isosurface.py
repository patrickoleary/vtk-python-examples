...
# Extract and display the skin and bone isosurfaces from a CT head dataset.
# The skin is rendered semi-transparent to reveal the bone beneath.
...
render_window.SetWindowName("skin and bone isosurface")
