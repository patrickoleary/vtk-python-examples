...
arr_height = vtkFloatArray()
arr_height.SetName("Height")
table.AddColumn(arr_height)
arr_weight = vtkFloatArray()
arr_weight.SetName("Weight")
table.AddColumn(arr_weight)
arr_age = vtkFloatArray()
arr_age.SetName("Age")
table.AddColumn(arr_age)
arr_income = vtkFloatArray()
arr_income.SetName("Income")
table.AddColumn(arr_income)
...
render_window.SetWindowName("scatter plot matrix")
