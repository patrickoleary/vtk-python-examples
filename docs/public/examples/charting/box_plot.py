...
raw_table = vtkTable()
arr_narrow = vtkFloatArray()
arr_narrow.SetName("Narrow")
raw_table.AddColumn(arr_narrow)
arr_medium = vtkFloatArray()
arr_medium.SetName("Medium")
raw_table.AddColumn(arr_medium)
arr_wide = vtkFloatArray()
arr_wide.SetName("Wide")
raw_table.AddColumn(arr_wide)
arr_shifted = vtkFloatArray()
arr_shifted.SetName("Shifted")
raw_table.AddColumn(arr_shifted)
arr_bimodal = vtkFloatArray()
arr_bimodal.SetName("Bimodal")
raw_table.AddColumn(arr_bimodal)
...
INPUT_DATA = 0  # INPUT_MODEL = 2
quartiles.SetInputData(INPUT_DATA, raw_table)
quartiles.Update()
...
render_window.SetWindowName("box plot")
