...
# Test the Background variable on vtkImageResliceMapper with beach.tif.
...
# Viewport 3: resample off + separate window/level on
...
image_mapper_3.SeparateWindowLevelOperationOn()
...
render_window.SetWindowName("reslice mapper background")
