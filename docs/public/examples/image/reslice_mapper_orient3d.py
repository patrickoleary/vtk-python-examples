...
# Test 3D images not in the XY plane with vtkImageResliceMapper.
...
# Viewport 0: camera along X axis
...
# Viewport 1: camera along Y axis
...
# Viewport 2: camera along Z axis
...
# Viewport 3: camera along X axis, oblique view
...
render_window.SetWindowName("reslice mapper orient3d")
