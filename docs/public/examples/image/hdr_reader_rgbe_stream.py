...
# Read an HDR RGBE file via vtkFileResourceStream with cropping and display.
...
file_stream.Open(os.path.join(data_dir, "spiaggia_di_mondello_1k.hdr"))

# Read HDR from stream
hdr_reader = vtkHDRReader()
hdr_reader.SetStream(file_stream)
...
render_window.SetWindowName("hdr reader rgbe stream")
