...
# Test the Border variable on vtkImageSliceMapper with beach.tif.
...
# Viewport 1: border on, linear interpolation
...
# Viewport 2: no border, nearest interpolation
...
render_window.SetWindowName("slice mapper border")
