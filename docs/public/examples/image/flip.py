...
renderer_0.SetBackground(left_background_rgb)
renderer_0.ResetCamera()

# Renderer 2: right viewport — flipped
renderer_1 = vtkRenderer()
renderer_1.AddActor(flipped_actor)
renderer_1.SetViewport(0.5, 0.0, 1.0, 1.0)
renderer_1.SetBackground(right_background_rgb)
...
render_window.SetWindowName("flip")
