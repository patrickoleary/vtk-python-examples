...
# Test oriented 3D images with vtkImageSliceMapper using a rotated Direction matrix.
...
# Read headsq data with custom direction
...
# Viewport 3: default orientation (Z), oblique view
...
render_window.SetWindowName("slice mapper rotate3d")
