...
# Read an HDR XYZ file via vtkFileResourceStream with cropping and display.
...
file_stream.Open(os.path.join(data_dir, "gradient_xyz.hdr"))
...
render_window.SetWindowName("hdr reader xyz stream")
