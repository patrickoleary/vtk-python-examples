#!/usr/bin/env python
# Demonstrate vtkTreeHeatmapItem with tree color array and custom line width.
...
# Tree heatmap item with color array and line width.
tree_item = vtkTreeHeatmapItem()
tree_item.SetTree(tree)
tree_item.SetTable(table)
tree_item.SetTreeColorArray("node weight")
tree_item.SetTreeLineWidth(2.0)
...
context_transform.Translate(40, 30)
...
render_window.SetWindowName("tree heatmap item")
