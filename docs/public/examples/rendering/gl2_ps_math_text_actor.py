...
# Demonstrate vtkGL2PSExporter with vtkTextActor and MathText via matplotlib.
...
render_window.SetWindowName("gl2 ps math text actor")
...
exporter.SetFilePrefix(tempfile.mktemp(prefix="GL2PSMathTextActor"))
exporter.Write()
