...
# Demonstrate lighting map normals render pass on a dragon mesh.
...
# Lighting map normals pass pipeline
lighting_pass = vtkLightingMapPass()
lighting_pass.SetRenderType(vtkLightingMapPass.NORMALS)
...
render_window.SetWindowName("lighting map normals pass")
