...
# Demonstrate point fill render pass on three dragon models rendered as points.
...
from vtkmodules.vtkRenderingOpenGL2 import vtkCameraPass, vtkPointFillPass, vtkRenderStepsPass
...
# Dragon 1: warm colors, offset position
actor_0 = vtkActor()
...
actor_0.GetProperty().SetRepresentationToPoints()

# Dragon 2: cool colors, default position
actor_1 = vtkActor()
...
# Dragon 3: blue-ish, offset position
actor_2 = vtkActor()
...
# Point fill pass pipeline
basic_passes = vtkRenderStepsPass()
pfp = vtkPointFillPass()
pfp.SetDelegatePass(basic_passes)
cam_pass = vtkCameraPass()
cam_pass.SetDelegatePass(pfp)
renderer.SetPass(cam_pass)
...
render_window.SetWindowName("point fill pass")
