...
# Demonstrate cubemap reflection on a bunny model using shader replacements.
...
# Shader replacements for cubemap reflection
...
render_window.SetWindowName("cube map")
