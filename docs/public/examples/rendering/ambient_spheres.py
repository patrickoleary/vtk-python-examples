...
# Demonstrate the effect of the ambient lighting coefficient on a row of
# eight spheres, with ambient increasing from 0.125 to 1.0.
...
# Actor 0: ambient 0.125
actor_0 = vtkActor()
actor_0.SetMapper(mapper)
actor_0.GetProperty().SetColor(sphere_color)
actor_0.GetProperty().SetAmbient(0.125)
actor_0.GetProperty().SetDiffuse(0.0)
actor_0.GetProperty().SetSpecular(0.0)
actor_0.AddPosition(0.0, 0.0, 0.0)

# Actor 1: ambient 0.250
actor_1 = vtkActor()
actor_1.SetMapper(mapper)
actor_1.GetProperty().SetColor(sphere_color)
actor_1.GetProperty().SetAmbient(0.250)
actor_1.GetProperty().SetDiffuse(0.0)
actor_1.GetProperty().SetSpecular(0.0)
actor_1.AddPosition(1.25, 0.0, 0.0)

# Actor 2: ambient 0.375
actor_2 = vtkActor()
actor_2.SetMapper(mapper)
actor_2.GetProperty().SetColor(sphere_color)
actor_2.GetProperty().SetAmbient(0.375)
actor_2.GetProperty().SetDiffuse(0.0)
actor_2.GetProperty().SetSpecular(0.0)
actor_2.AddPosition(2.50, 0.0, 0.0)

# Actor 3: ambient 0.500
actor_3 = vtkActor()
actor_3.SetMapper(mapper)
actor_3.GetProperty().SetColor(sphere_color)
actor_3.GetProperty().SetAmbient(0.500)
actor_3.GetProperty().SetDiffuse(0.0)
actor_3.GetProperty().SetSpecular(0.0)
actor_3.AddPosition(3.75, 0.0, 0.0)

# Actor 4: ambient 0.625
actor_4 = vtkActor()
actor_4.SetMapper(mapper)
actor_4.GetProperty().SetColor(sphere_color)
actor_4.GetProperty().SetAmbient(0.625)
actor_4.GetProperty().SetDiffuse(0.0)
actor_4.GetProperty().SetSpecular(0.0)
actor_4.AddPosition(0.0, 1.25, 0.0)

# Actor 5: ambient 0.750
actor_5 = vtkActor()
actor_5.SetMapper(mapper)
actor_5.GetProperty().SetColor(sphere_color)
actor_5.GetProperty().SetAmbient(0.750)
actor_5.GetProperty().SetDiffuse(0.0)
actor_5.GetProperty().SetSpecular(0.0)
actor_5.AddPosition(1.25, 1.25, 0.0)

# Actor 6: ambient 0.875
actor_6 = vtkActor()
actor_6.SetMapper(mapper)
actor_6.GetProperty().SetColor(sphere_color)
actor_6.GetProperty().SetAmbient(0.875)
actor_6.GetProperty().SetDiffuse(0.0)
actor_6.GetProperty().SetSpecular(0.0)
actor_6.AddPosition(2.50, 1.25, 0.0)

# Actor 7: ambient 1.000
actor_7 = vtkActor()
actor_7.SetMapper(mapper)
actor_7.GetProperty().SetColor(sphere_color)
actor_7.GetProperty().SetAmbient(1.000)
actor_7.GetProperty().SetDiffuse(0.0)
actor_7.GetProperty().SetSpecular(0.0)
...
render_window.SetWindowName("ambient spheres")
