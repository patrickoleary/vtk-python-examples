...
# Six incremental rotations of the cow model about the Y axis,
...
render_window.SetWindowName("rotation incremental y")
...
# Camera: front view along Z to show Y-axis rotation
...
# Animation: six 60° rotations about Y with EraseOff overlay
