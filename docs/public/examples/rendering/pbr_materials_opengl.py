...
# Demonstrate PBR materials with varying roughness and metallic properties using a skybox.
...
# Scene lights
light_1 = vtkLight()
light_1.SetPositional(True)

light_2 = vtkLight()
light_2.SetPosition(2, 1, 1)
light_2.SetFocalPoint(2, 1, 0)
light_2.SetColor(1.0, 0.6, 1.0)
light_2.SetPositional(False)
...
actor_r0_1.GetProperty().SetColor(1.0, 1.0, 1.0)
...
actor_r0_2.GetProperty().SetColor(1.0, 1.0, 1.0)
...
actor_r0_3.GetProperty().SetColor(1.0, 1.0, 1.0)
...
actor_r0_4.GetProperty().SetColor(1.0, 1.0, 1.0)
...
actor_r2_1.GetProperty().SetColor(0.0, 0.0, 0.0)
...
actor_r2_2.GetProperty().SetColor(0.0, 0.0, 0.0)
...
actor_r2_3.GetProperty().SetColor(0.0, 0.0, 0.0)
...
actor_r2_4.GetProperty().SetColor(0.0, 0.0, 0.0)
...
actor_r3_1.GetProperty().SetColor(0.0, 1.0, 1.0)
...
actor_r3_2.GetProperty().SetColor(0.0, 1.0, 1.0)
...
actor_r3_3.GetProperty().SetColor(0.0, 1.0, 1.0)
...
actor_r3_4.GetProperty().SetColor(0.0, 1.0, 1.0)
...
actor_r4_1.GetProperty().SetColor(1.0, 0.0, 0.0)
...
actor_r4_2.GetProperty().SetColor(1.0, 0.0, 0.0)
...
actor_r4_3.GetProperty().SetColor(1.0, 0.0, 0.0)
...
actor_r4_4.GetProperty().SetColor(1.0, 0.0, 0.0)
...
actor_r4_5.GetProperty().SetColor(1.0, 0.0, 0.0)
...
render_window.SetWindowName("pbr materials opengl")
