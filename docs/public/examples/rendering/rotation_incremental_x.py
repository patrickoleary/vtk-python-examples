...
# Six incremental rotations of the cow model about the X axis,
...
render_window.SetWindowName("rotation incremental x")
...
# Camera: top-down view along Y to show X-axis rotation
...
# Animation: six 60° rotations about X with EraseOff overlay
