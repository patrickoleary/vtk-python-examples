...
# origin set to the nose tip at (6.11414, 1.27386, 0.015175).  Rendered
# with EraseOff overlay (VTK Textbook figure 3-33b).
...
# Actor: the cow model with origin at the nose
cow_actor = vtkActor()
...
render_window.SetWindowName("walk cow transform sequence")
...
cow_actor.SetOrigin(6.11414, 1.27386, 0.015175)
...
renderer.GetActiveCamera().SetPosition(31, 23, -21)
