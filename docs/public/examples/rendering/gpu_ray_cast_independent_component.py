...
# Demonstrate GPU volume ray casting with independent component transfer functions on a 4-component dataset.
...
render_window.SetWindowName("gpu ray cast independent component")
