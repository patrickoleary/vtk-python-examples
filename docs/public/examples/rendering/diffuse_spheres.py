...
# Demonstrate the effect of the diffuse lighting coefficient on a row of
# eight spheres, with diffuse increasing from 0.0 to 0.875.
...
render_window.SetWindowName("diffuse spheres")
