...
actor_r0_0.GetProperty().SetColor(brass)
...
actor_r0_1.GetProperty().SetColor(brass)
...
actor_r0_2.GetProperty().SetColor(brass)
...
actor_r0_3.GetProperty().SetColor(brass)
...
actor_r0_4.GetProperty().SetColor(brass)
...
actor_r0_5.GetProperty().SetColor(brass)
...
actor_r2_0.GetProperty().SetCoatColor(red)
...
actor_r2_1.GetProperty().SetCoatColor(red)
...
actor_r2_2.GetProperty().SetCoatColor(red)
...
actor_r2_3.GetProperty().SetCoatColor(red)
...
actor_r2_4.GetProperty().SetCoatColor(red)
...
actor_r2_5.GetProperty().SetCoatColor(red)
...
actor_r3_0.GetProperty().SetColor(white)
actor_r3_0.GetProperty().SetRoughness(0.1)
actor_r3_0.GetProperty().SetCoatColor(red)
...
actor_r3_1.GetProperty().SetColor(white)
actor_r3_1.GetProperty().SetRoughness(0.1)
actor_r3_1.GetProperty().SetCoatColor(red)
...
actor_r3_2.GetProperty().SetColor(white)
actor_r3_2.GetProperty().SetRoughness(0.1)
actor_r3_2.GetProperty().SetCoatColor(red)
...
actor_r3_3.GetProperty().SetColor(white)
actor_r3_3.GetProperty().SetRoughness(0.1)
actor_r3_3.GetProperty().SetCoatColor(red)
...
actor_r3_4.GetProperty().SetColor(white)
actor_r3_4.GetProperty().SetRoughness(0.1)
actor_r3_4.GetProperty().SetCoatColor(red)
...
actor_r3_5.GetProperty().SetColor(white)
actor_r3_5.GetProperty().SetRoughness(0.1)
actor_r3_5.GetProperty().SetCoatColor(red)
...
actor_r4_0.GetProperty().SetColor(dark_teal)
...
actor_r4_1.GetProperty().SetColor(dark_teal)
...
actor_r4_2.GetProperty().SetColor(dark_teal)
actor_r4_2.GetProperty().SetBaseIOR(1.6666666666666665)

actor_r4_3 = vtkActor()
actor_r4_3.SetPosition(3, 4.0, 0.0)
actor_r4_3.SetMapper(mapper)
actor_r4_3.GetProperty().SetInterpolationToPBR()
actor_r4_3.GetProperty().SetColor(dark_teal)
...
actor_r4_4.GetProperty().SetColor(dark_teal)
...
actor_r4_5.GetProperty().SetColor(dark_teal)
...
render_window.SetWindowName("pbr materials coat")
