...
# Demonstrate PBR rendering with base color texture and interpolated scalar coloring.
...
# Cloud texture as PBR base color with modulate blending
...
actor.GetProperty().SetBaseColorTexture(tex)
...
render_window.SetWindowName("pbr texture interpolate scalars")
