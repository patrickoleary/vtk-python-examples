...
# Demonstrate GPU volume ray casting with minimum intensity projection on independent components.
...
render_window.SetWindowName("gpu ray cast independent component min ip")
