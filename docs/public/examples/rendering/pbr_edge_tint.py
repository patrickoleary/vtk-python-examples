...
# Render five rows of PBR metallic spheres with different edge tint colors
# and increasing roughness.  Row 0: white / black tint, row 1: black /
# white tint, row 2: blue / red tint, row 3: red / blue tint, row 4:
# black / yellow tint.
...
# Row 0: white surface, black edge tint, roughness 0.0 to 1.0
actor_r0_0 = vtkActor()
...
actor_r0_0.GetProperty().SetEdgeTint(black)
...
actor_r0_1.GetProperty().SetEdgeTint(black)
...
actor_r0_2.GetProperty().SetEdgeTint(black)
...
actor_r0_3.GetProperty().SetEdgeTint(black)
...
actor_r0_4.GetProperty().SetEdgeTint(black)
...
actor_r1_1.GetProperty().SetColor(black)
actor_r1_1.GetProperty().SetMetallic(1.0)
actor_r1_1.GetProperty().SetEdgeTint(white)
...
actor_r1_2.GetProperty().SetColor(black)
actor_r1_2.GetProperty().SetMetallic(1.0)
actor_r1_2.GetProperty().SetEdgeTint(white)
...
actor_r1_3.GetProperty().SetColor(black)
actor_r1_3.GetProperty().SetMetallic(1.0)
actor_r1_3.GetProperty().SetEdgeTint(white)
...
actor_r1_4.GetProperty().SetColor(black)
actor_r1_4.GetProperty().SetMetallic(1.0)
actor_r1_4.GetProperty().SetEdgeTint(white)
...
actor_r2_1.GetProperty().SetColor(blue)
actor_r2_1.GetProperty().SetMetallic(1.0)
actor_r2_1.GetProperty().SetEdgeTint(red)
...
actor_r2_2.GetProperty().SetColor(blue)
actor_r2_2.GetProperty().SetMetallic(1.0)
actor_r2_2.GetProperty().SetEdgeTint(red)
...
actor_r2_3.GetProperty().SetColor(blue)
actor_r2_3.GetProperty().SetMetallic(1.0)
actor_r2_3.GetProperty().SetEdgeTint(red)
...
actor_r2_4.GetProperty().SetColor(blue)
actor_r2_4.GetProperty().SetMetallic(1.0)
actor_r2_4.GetProperty().SetEdgeTint(red)
...
actor_r3_1.GetProperty().SetColor(red)
actor_r3_1.GetProperty().SetMetallic(1.0)
actor_r3_1.GetProperty().SetEdgeTint(blue)
...
actor_r3_2.GetProperty().SetColor(red)
actor_r3_2.GetProperty().SetMetallic(1.0)
actor_r3_2.GetProperty().SetEdgeTint(blue)
...
actor_r3_3.GetProperty().SetColor(red)
actor_r3_3.GetProperty().SetMetallic(1.0)
actor_r3_3.GetProperty().SetEdgeTint(blue)
...
actor_r3_4.GetProperty().SetColor(red)
actor_r3_4.GetProperty().SetMetallic(1.0)
actor_r3_4.GetProperty().SetEdgeTint(blue)
...
actor_r4_1.GetProperty().SetColor(black)
actor_r4_1.GetProperty().SetMetallic(1.0)
actor_r4_1.GetProperty().SetEdgeTint(yellow)
...
actor_r4_2.GetProperty().SetColor(black)
actor_r4_2.GetProperty().SetMetallic(1.0)
actor_r4_2.GetProperty().SetEdgeTint(yellow)
...
actor_r4_3.GetProperty().SetColor(black)
actor_r4_3.GetProperty().SetMetallic(1.0)
actor_r4_3.GetProperty().SetEdgeTint(yellow)
...
actor_r4_4.GetProperty().SetColor(black)
actor_r4_4.GetProperty().SetMetallic(1.0)
actor_r4_4.GetProperty().SetEdgeTint(yellow)
...
actor_r4_5.GetProperty().SetColor(black)
actor_r4_5.GetProperty().SetMetallic(1.0)
actor_r4_5.GetProperty().SetEdgeTint(yellow)
...
render_window.SetWindowName("pbr edge tint")
