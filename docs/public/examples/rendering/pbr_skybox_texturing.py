...
# Demonstrate physically based rendering with isotropic texturing on Boy's
# parametric surface.  Albedo, normal, and ORM (occlusion/roughness/metallic)
...
# Actor: PBR Boy's surface with isotropic textures
actor = vtkActor()
...
render_window.SetWindowName("pbr skybox texturing")
