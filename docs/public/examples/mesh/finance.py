...
file_name = os.path.join(data_dir, "financial.txt")
...
# Filter: total population splatter and contour
...
# Filter: delinquent population splatter and contour
...
# Filter: tube axes at the data origin
pop_splatter.Update()
...
# Mapper: total population (gray translucent surface)
...
# Mapper: delinquent population (red surface)
