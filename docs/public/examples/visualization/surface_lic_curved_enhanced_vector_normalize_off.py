...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICCurvedEnhancedVectorNormalizeOff.
...
render_window.SetWindowName("surface lic curved enhanced vector normalize off")
