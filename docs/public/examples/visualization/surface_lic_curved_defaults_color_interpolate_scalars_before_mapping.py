...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICCurvedDefaultsColorInterpolateScalarsBeforeMapping.
...
lic_mapper.SetInterpolateScalarsBeforeMapping(1)
...
lic_interface.SetLICIntensity(0.3)
...
render_window.SetWindowName("surface lic curved defaults color interpolate scalars before mapping")
