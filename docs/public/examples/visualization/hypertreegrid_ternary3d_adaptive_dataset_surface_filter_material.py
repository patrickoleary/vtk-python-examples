#!/usr/bin/env python
# Demonstrate vtkAdaptiveDataSetSurfaceFilter on a 3D ternary HyperTreeGrid with material mask.
...
# HyperTreeGrid source: 3D ternary with material mask
...
render_window.SetWindowName("hypertreegrid ternary3d adaptive dataset surface filter material")
