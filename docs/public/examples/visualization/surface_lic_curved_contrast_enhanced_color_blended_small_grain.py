...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICCurvedContrastEnhancedColorBlendedSmallGrain.
...
render_window.SetWindowName("surface lic curved contrast enhanced color blended small grain")
