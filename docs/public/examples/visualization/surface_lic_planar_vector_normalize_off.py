...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICPlanarVectorNormalizeOff.
...
lic_interface.SetNumberOfSteps(2000)
...
lic_interface.SetNoiseGeneratorSeed(12367)
...
render_window.SetWindowName("surface lic planar vector normalize off")
