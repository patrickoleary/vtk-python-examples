...
# Display marching cubes case 3 rotated 90 degrees.
...
# Case 3 vertex pattern: 1=IN, 0=OUT
...
# Renderer: assemble the scene (rotated 90 degrees)
...
render_window.SetWindowName("marching cubes case 3")
