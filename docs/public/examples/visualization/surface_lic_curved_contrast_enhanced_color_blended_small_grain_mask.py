...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICCurvedContrastEnhancedColorBlendedSmallGrainMask.
...
render_window.SetWindowName("surface lic curved contrast enhanced color blended small grain mask")
