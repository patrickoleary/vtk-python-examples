...
# Demonstrate 2D image warping with nearest neighbor interpolation using
...
# Convert thin plate spline into a grid (nearest neighbor needs precise overlay)
transform_to_grid = vtkTransformToGrid()
transform_to_grid.SetInput(thin_plate)
transform_to_grid.SetGridSpacing(1, 1, 1)
transform_to_grid.SetGridOrigin(0, 0, 0)
transform_to_grid.SetGridExtent(0, 255, 0, 255, 0, 0)
...
render_window.SetWindowName("grid warp nearest")
