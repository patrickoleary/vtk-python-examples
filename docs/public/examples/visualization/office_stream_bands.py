...
# Visualize office airflow using streamlines seeded near the window.
...
# Source: seed points for streamlines near the window (center 2)
...
render_window.SetWindowName("office stream bands")
