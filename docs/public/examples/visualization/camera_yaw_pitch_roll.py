...
# Illustrate camera movement centered at the camera position (yaw, pitch, roll).
...
yaw_color = (1.000, 0.302, 0.302)
pitch_color = (0.302, 1.000, 0.302)
roll_color = (1.000, 1.000, 0.302)
spike_color = (1.000, 0.302, 1.000)
up_spike_color = (0.302, 1.000, 1.000)
...
arrow_pts.InsertNextPoint(10, 0, 0)
arrow_pts.InsertNextPoint(8, -2, 0)
arrow_pts.InsertNextPoint(8, -1, 0)
arrow_pts.InsertNextPoint(0, -1, 0)
...
a1_actor.SetPosition(-9, 0, -1)
a1_actor.GetProperty().SetColor(yaw_color)
...
a2_actor.SetPosition(-9, 0, 1)
a2_actor.GetProperty().SetColor(yaw_color)
...
a3_actor.RotateX(-90)
a3_actor.SetPosition(-9, -1, 0)
a3_actor.GetProperty().SetColor(pitch_color)
...
a4_actor.RotateX(90)
a4_actor.SetPosition(-9, 1, 0)
a4_actor.GetProperty().SetColor(pitch_color)
...
a5_actor.RotateY(-90)
a5_actor.SetPosition(-8, 0, 0)
a5_actor.GetProperty().SetColor(spike_color)
a5_actor.GetProperty().SetSpecularColor(white)
a5_actor.GetProperty().SetSpecular(0.3)
a5_actor.GetProperty().SetAmbient(0.2)
a5_actor.GetProperty().SetDiffuse(0.8)
a5_actor.GetProperty().SetSpecularPower(20)

# Actor: view-up spike
a7_actor = vtkLODActor()
a7_actor.SetMapper(spike_mapper)
a7_actor.SetScale(0.2, 0.2, 0.7)
a7_actor.RotateZ(90)
a7_actor.RotateY(-90)
a7_actor.SetPosition(-9, 1, 0)
a7_actor.GetProperty().SetColor(up_spike_color)
a7_actor.GetProperty().SetSpecularColor(white)
a7_actor.GetProperty().SetSpecular(0.3)
a7_actor.GetProperty().SetAmbient(0.2)
a7_actor.GetProperty().SetDiffuse(0.8)
a7_actor.GetProperty().SetSpecularPower(20)
...
# Text: label for yaw
text_yaw = vtkTextActor()
text_yaw.SetInput("Yaw")
tp = text_yaw.GetTextProperty()
tp.SetFontFamilyToArial()
tp.ShadowOff()
tp.SetLineSpacing(1.0)
tp.SetFontSize(36)
tp.SetColor(yaw_color)
text_yaw.SetDisplayPosition(20, 50)
renderer.AddViewProp(text_yaw)

# Text: label for pitch
text_pitch = vtkTextActor()
text_pitch.SetInput("Pitch")
tp2 = text_pitch.GetTextProperty()
tp2.SetFontFamilyToArial()
tp2.ShadowOff()
tp2.SetLineSpacing(1.0)
tp2.SetFontSize(36)
tp2.SetColor(pitch_color)
text_pitch.SetDisplayPosition(20, 100)
renderer.AddViewProp(text_pitch)
...
render_window.SetWindowName("camera yaw pitch roll")
