...
light_actor_1 = vtkLightActor()
light_actor_1.SetLight(l1)
renderer.AddViewProp(light_actor_1)
light_actor_2 = vtkLightActor()
light_actor_2.SetLight(l2)
renderer.AddViewProp(light_actor_2)
...
render_window.SetWindowName("shadows lights demo")
