...
# Test vtkStructuredGridLIC2D with a Z-direction slice.
...
# Z slice (XY plane)
voi[4] = voi[5] = max(extent[4], min(extent[4] + slice_idx, extent[5]))
...
if lic_filter.SetContext(render_window) == 0:
    ...
    render_window.SetWindowName("structuredgrid lic2 dz slice")
