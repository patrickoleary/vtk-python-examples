...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICPlanarVectorNormalizeOffMediumGrainPerlin.
...
lic_interface.SetNumberOfSteps(400)
lic_interface.SetStepSize(2.0)
...
lic_interface.SetNoiseTextureSize(256)
lic_interface.SetNoiseGrainSize(8)
lic_interface.SetMinNoiseValue(0.0)
lic_interface.SetMaxNoiseValue(0.8)
...
render_window.SetWindowName("surface lic planar vector normalize off medium grain perlin")
