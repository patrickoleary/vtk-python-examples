...
renderer_0.AddActor(decimated_actor)
renderer_0.SetBackground(sienna)

# Renderer: right viewport shows original mesh
renderer_1 = vtkRenderer()
renderer_1.SetViewport(0.5, 0.0, 1.0, 1.0)
renderer_1.AddActor(original_actor)
renderer_1.SetBackground(wheat)
...
render_window.SetWindowName("decimate hawaii")
render_window.SetMultiSamples(0)
render_window.SetSize(800, 400)

# Scene: configure the camera
renderer_0.GetActiveCamera().SetPosition(0, -1, 0)
