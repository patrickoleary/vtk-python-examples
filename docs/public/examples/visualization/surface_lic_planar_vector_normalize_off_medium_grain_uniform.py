...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICPlanarVectorNormalizeOffMediumGrainUniform.
...
lic_interface.SetStepSize(0.25)
lic_interface.SetEnhancedLIC(0)
...
lic_interface.SetImpulseNoiseProbability(0.04)
...
lic_interface.SetHighColorContrastEnhancementFactor(0.2)
...
render_window.SetWindowName("surface lic planar vector normalize off medium grain uniform")
