...
# Demonstrate vtkProcrustesAlignmentFilter aligning three distorted spheres
# using rigid body and similarity modes in a 3-viewport layout.
...
# -- Procrustes rigid body alignment --
...
render_window.SetWindowName("procrustes")
