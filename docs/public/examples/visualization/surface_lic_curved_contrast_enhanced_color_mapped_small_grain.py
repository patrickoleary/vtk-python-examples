...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICCurvedContrastEnhancedColorMappedSmallGrain.
...
render_window.SetWindowName("surface lic curved contrast enhanced color mapped small grain")
