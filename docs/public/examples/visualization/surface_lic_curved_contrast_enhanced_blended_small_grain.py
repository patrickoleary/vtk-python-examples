...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICCurvedContrastEnhancedBlendedSmallGrain.
...
render_window.SetWindowName("surface lic curved contrast enhanced blended small grain")
