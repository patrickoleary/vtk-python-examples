...
# Demonstrate 2D image warping with linear interpolation using
...
blend = vtkImageBlend()
blend.AddInputConnection(0, reader.GetOutputPort(0))
...
# Apply the grid warp to the image using the inverse transform
...
render_window.SetWindowName("grid warp linear")
