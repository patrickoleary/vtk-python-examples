#!/usr/bin/env python
# Demonstrate vtkAdaptiveDataSetSurfaceFilter on a 3D ternary HyperTreeGrid.
...
render_window.SetWindowName("hypertreegrid ternary3d adaptive dataset surface filter")
