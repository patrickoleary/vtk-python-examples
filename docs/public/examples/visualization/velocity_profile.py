...
plane_0.SetExtent(10, 10, 1, extent[3], 1, extent[5])

plane_1 = vtkStructuredGridGeometryFilter()
plane_1.SetInputData(sg)
plane_1.SetExtent(30, 30, 1, extent[3], 1, extent[5])

plane_2 = vtkStructuredGridGeometryFilter()
plane_2.SetInputData(sg)
plane_2.SetExtent(45, 45, 1, extent[3], 1, extent[5])
...
render_window.SetWindowName("velocity profile")
