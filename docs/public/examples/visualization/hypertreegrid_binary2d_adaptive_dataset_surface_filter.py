#!/usr/bin/env python
# Demonstrate vtkAdaptiveDataSetSurfaceFilter on a 2D binary HyperTreeGrid.
...
# HyperTreeGrid source: 2D binary in XY plane
...
render_window.SetWindowName("hypertreegrid binary2d adaptive dataset surface filter")
