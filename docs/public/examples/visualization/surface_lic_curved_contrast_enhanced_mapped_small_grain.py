...
# Test vtkCompositeSurfaceLICMapper: SurfaceLICCurvedContrastEnhancedMappedSmallGrain.
...
render_window.SetWindowName("surface lic curved contrast enhanced mapped small grain")
