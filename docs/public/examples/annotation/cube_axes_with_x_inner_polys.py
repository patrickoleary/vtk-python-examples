...
# Test vtkCubeAxesActor with X inner grid polygons on a teapot model.
...
# Cube axes with X inner grid polygons
...
render_window.SetWindowName("cube axes with x inner polys")
