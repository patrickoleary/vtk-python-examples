...
# Test vtkTextMapper without math text, with various fonts and UTF-8.
...
# Mapper/actor 9: courier bold italic number
mapper_9 = vtkTextMapper()
actor_9 = vtkActor2D()
actor_9.SetMapper(mapper_9)
mapper_9.GetTextProperty().SetFontSize(21)
mapper_9.GetTextProperty().SetColor(1.0, 0.0, 0.0)
mapper_9.GetTextProperty().SetJustificationToCentered()
mapper_9.GetTextProperty().SetVerticalJustificationToCentered()
mapper_9.GetTextProperty().SetBold(1)
mapper_9.GetTextProperty().SetItalic(1)
mapper_9.GetTextProperty().SetFontFamilyToCourier()
mapper_9.SetInput("4.0")
actor_9.SetPosition(500, 400)

# Mapper/actor 10: UTF-8 with custom font
mapper_10 = vtkTextMapper()
actor_10 = vtkActor2D()
actor_10.SetMapper(mapper_10)
mapper_10.GetTextProperty().SetFontFile(font_file)
mapper_10.GetTextProperty().SetFontFamily(VTK_FONT_FILE)
mapper_10.GetTextProperty().SetJustificationToCentered()
mapper_10.GetTextProperty().SetVerticalJustificationToCentered()
mapper_10.GetTextProperty().SetFontSize(18)
mapper_10.GetTextProperty().SetColor(0.0, 1.0, 0.7)
mapper_10.SetInput("UTF-8 FreeType: \u03a8\u0494\u0496\u0444\u04be")
actor_10.SetPosition(300, 110)

# Mapper/actor 11: rotated kerning test
mapper_11 = vtkTextMapper()
actor_11 = vtkActor2D()
actor_11.SetMapper(mapper_11)
mapper_11.GetTextProperty().SetFontFile(font_file)
mapper_11.GetTextProperty().SetFontFamily(VTK_FONT_FILE)
mapper_11.GetTextProperty().SetJustificationToCentered()
mapper_11.GetTextProperty().SetVerticalJustificationToCentered()
mapper_11.GetTextProperty().SetFontSize(18)
mapper_11.GetTextProperty().SetOrientation(90)
mapper_11.GetTextProperty().SetColor(0.0, 1.0, 0.7)
mapper_11.SetInput("oTeVaVoVAW")
actor_11.SetPosition(300, 200)

# Mapper/actor 12: empty string with solid background (should not render)
mapper_12 = vtkTextMapper()
actor_12 = vtkActor2D()
actor_12.SetMapper(mapper_12)
mapper_12.GetTextProperty().SetFontSize(16)
mapper_12.GetTextProperty().SetColor(1.0, 0.0, 0.0)
mapper_12.GetTextProperty().SetBackgroundColor(1.0, 0.5, 1.0)
mapper_12.GetTextProperty().SetBackgroundOpacity(1.0)
mapper_12.GetTextProperty().SetJustificationToRight()
mapper_12.GetTextProperty().SetVerticalJustificationToCentered()
mapper_12.SetInput("")
actor_12.SetPosition(0, 0)
...
render_window.SetWindowName("free type text mapper no math")
