...
# Test vtkTextActor with DPI scaling, various fonts, alignments, and math text.
...
# Actor 11: invalid latex markup (fallback)
...
# Actor 15: UTF-8 with custom font file
...
actor_16.GetTextProperty().SetFontFile(font_file)
...
render_window.SetWindowName("font dpi scaling")
