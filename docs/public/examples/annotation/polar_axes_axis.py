...
# Test vtkPolarAxesActor with custom axis tick location, minor ticks, and title.
...
from vtkmodules.vtkRenderingAnnotation import vtkAxisActor, vtkPolarAxesActor
...
# Polar axes with axis customization
...
polar_axes.SetMinimumAngle(0)
polar_axes.SetMaximumAngle(180)
polar_axes.SetRequestedNumberOfRadialAxes(5)
polar_axes.SetRadialUnits(False)
polar_axes.SetTickLocation(vtkAxisActor.VTK_TICKS_INSIDE)
polar_axes.SetAxisMinorTickVisibility(True)
polar_axes.SetLastRadialAxisMajorTickSize(1.0)
polar_axes.SetPolarAxisMajorTickThickness(2.5)
polar_axes.SetPolarLabelOffset(22)
polar_axes.SetPolarAxisTitle("Testing Polar Axes Title")
polar_axes.SetDrawPolarArcsGridlines(False)
...
render_window.SetWindowName("polar axes axis")
