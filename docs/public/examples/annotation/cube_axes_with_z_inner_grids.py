...
# Test vtkCubeAxesActor with Z inner gridlines on a teapot model.
...
# Cube axes with Z inner gridlines
...
axes.SetDrawZInnerGridlines(True)
...
render_window.SetWindowName("cube axes with z inner grids")
