...
# Demonstrate vtkXYPlotActor plotting arbitrary array components (Momentum).
...
# XY Plot 1 — zoomed pressure with legends
...
# XY Plot 2 — with vertex glyph and custom legend labels
vertex_glyph = vtkSphereSource()
vertex_glyph.Update()

xyplot_2 = vtkXYPlotActor()
xyplot_2.AddDataSetInputConnection(probe.GetOutputPort())
...
xyplot_2.SetXRange(0.2, 1.0)
xyplot_2.SetTitle("VTK Quality vs. Alcohol Consumption")
xyplot_2.SetXTitle("")
xyplot_2.SetYTitle("A")
xyplot_2.PlotPointsOn()
xyplot_2.PlotLinesOff()
xyplot_2.LegendOn()
xyplot_2.SetLegendPosition(0.4, 0.6)
xyplot_2.SetLegendPosition2(0.40, 0.25)
xyplot_2.GetProperty().SetColor(1, 0, 0)
xyplot_2.GetProperty().SetPointSize(2)
xyplot_2.SetPlotSymbol(0, vertex_glyph.GetOutput())
xyplot_2.SetPlotLabel(0, "Ken's Mudslide Consumption")
xyplot_2.SetPlotColor(0, 1, 0, 0)
xyplot_2.SetPlotSymbol(1, cross.GetOutput())
xyplot_2.SetPlotColor(1, 1, 0, 1)
xyplot_2.SetPlotLabel(1, "Bill's Beer Consumption")
xyplot_2.SetPlotSymbol(2, triangle.GetOutput())
xyplot_2.SetPlotColor(2, 0, 0, 1)
xyplot_2.SetPlotLabel(2, "VTK Quality")
...
# XY Plot 3 — momentum components using AddDataSetInputConnection with array name
xyplot_3 = vtkXYPlotActor()
xyplot_3.AddDataSetInputConnection(probe.GetOutputPort(), "Momentum", 0)
xyplot_3.AddDataSetInputConnection(probe.GetOutputPort(), "Density", 0)
xyplot_3.AddDataSetInputConnection(probe.GetOutputPort(), "Momentum", 1)
xyplot_3.AddDataSetInputConnection(probe.GetOutputPort(), "Momentum", 2)
xyplot_3.RemoveDataSetInputConnection(probe.GetOutputPort(), "Density", 0)
...
xyplot_3.SetTitle("Momentum Component vs. Point Id")
xyplot_3.SetXTitle("Point Id")
xyplot_3.SetYTitle("M")
xyplot_3.PlotPointsOn()
xyplot_3.GetProperty().SetColor(0, 0, 1)
xyplot_3.GetProperty().SetPointSize(3)
xyplot_3.LegendOn()
xyplot_3.SetLegendPosition(0.8, 0.28)
xyplot_3.SetLegendPosition2(0.20, 0.20)
...
render_window.SetWindowName("xy plot array components")
