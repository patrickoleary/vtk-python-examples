...
# Test vtkCubeAxesActor with Y inner gridlines on a teapot model.
...
# Cube axes with Y inner gridlines
...
axes.SetDrawYInnerGridlines(True)
...
render_window.SetWindowName("cube axes with y inner grids")
