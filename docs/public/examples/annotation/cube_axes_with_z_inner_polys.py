...
# Test vtkCubeAxesActor with Z inner grid polygons on a teapot model.
...
# Cube axes with Z inner grid polygons
...
axes.SetDrawZGridpolys(True)
axes.GetZAxesGridpolysProperty().SetColor(0.2, 0.2, 0.2)
axes.GetZAxesGridpolysProperty().SetOpacity(0.3)
...
render_window.SetWindowName("cube axes with z inner polys")
