...
# Test vtkCubeAxesActor with centered sticky axes on a teapot model.
...
# Cube axes actor with centered sticky axes
...
render_window.SetWindowName("cube axes sticky centered")
...
renderer.GetActiveCamera().SetFocalPoint(-4.1, 1.0, 0.0)
renderer.GetActiveCamera().SetPosition(3.63, 6.0, 3.77)
