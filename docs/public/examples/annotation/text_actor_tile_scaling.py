...
# Test vtkTextActor with tile scaling, various alignments, orientations, and frames.
...
pt_id = anchor_points.InsertNextPoint(100, 232, 0.0)
anchor_verts.InsertNextCell(1, [pt_id])
...
pt_id = anchor_points.InsertNextPoint(300, 232, 0.0)
anchor_verts.InsertNextCell(1, [pt_id])
...
pt_id = anchor_points.InsertNextPoint(500, 232, 0.0)
anchor_verts.InsertNextCell(1, [pt_id])
...
pt_id = anchor_points.InsertNextPoint(100, 266, 0.0)
anchor_verts.InsertNextCell(1, [pt_id])
...
pt_id = anchor_points.InsertNextPoint(300, 266, 0.0)
anchor_verts.InsertNextCell(1, [pt_id])
...
pt_id = anchor_points.InsertNextPoint(500, 266, 0.0)
anchor_verts.InsertNextCell(1, [pt_id])
...
# Window with tile scaling
render_window = vtkRenderWindow()
render_window.AddRenderer(renderer)
render_window.SetWindowName("text actor tile scaling")
render_window.SetTileScale(tile_scale, tile_scale)
