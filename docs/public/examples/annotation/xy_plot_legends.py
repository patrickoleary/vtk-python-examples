...
# Demonstrate vtkXYPlotActor with legends, glyph symbols, and data objects.
...
append_f.AddInputConnection(probe_2.GetOutputPort())
append_f.AddInputConnection(probe_3.GetOutputPort())
...
# XY Plot 1 — zoomed pressure with legends and glyph symbols
...
# XY Plot 3 — data object momentum components
...
xyplot_3.AddDataObjectInputConnection(ds2do.GetOutputPort())
...
xyplot_3.AddDataObjectInput(ds2do_2.GetOutput())
...
render_window.SetWindowName("xy plot legends")
