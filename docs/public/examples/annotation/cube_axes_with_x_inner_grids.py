...
# Test vtkCubeAxesActor with X inner gridlines on a teapot model.
...
# Cube axes with X inner gridlines
...
axes.SetDrawXInnerGridlines(True)
...
render_window.SetWindowName("cube axes with x inner grids")
