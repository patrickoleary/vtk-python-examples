...
# Test vtkCubeAxesActor with Y inner grid polygons on a teapot model.
...
# Cube axes with Y inner grid polygons
...
render_window.SetWindowName("cube axes with y inner polys")
