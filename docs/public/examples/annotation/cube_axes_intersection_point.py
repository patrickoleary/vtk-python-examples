...
# Test vtkCubeAxesActor with axis origin intersection point using oriented bounds.
...
# Cube axes actor with axis origin
...
render_window.SetWindowName("cube axes intersection point")
