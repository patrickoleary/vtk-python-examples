...
# Test vtkCubeAxesActor with outer X gridlines and red X axis coloring.
...
# Cube axes with X outer gridlines
...
# Red for X axis lines, gridlines, title, and labels
...
axes.GetXAxesGridlinesProperty().SetColor(1.0, 0.0, 0.0)
...
render_window.SetWindowName("cube axes with x lines")
