...
# Test vtkCubeAxesActor with outer Z gridlines and blue Z axis coloring.
...
# Cube axes with Z outer gridlines
...
axes.GetZAxesGridlinesProperty().SetColor(0.0, 0.0, 1.0)
...
render_window.SetWindowName("cube axes with z lines")
