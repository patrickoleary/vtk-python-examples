...
# Test vtkCubeAxesActor with outer gridlines on all axes and colored axis properties.
...
# Cube axes with outer gridlines
...
# Blue for Z axis
axes.GetZAxesLinesProperty().SetColor(0.0, 0.0, 1.0)
axes.GetTitleTextProperty(2).SetColor(0.0, 0.0, 1.0)
axes.GetLabelTextProperty(2).SetColor(0.0, 0.0, 1.0)

# Olive for gridlines
axes.GetXAxesGridlinesProperty().SetColor(0.23, 0.37, 0.17)
axes.GetYAxesGridlinesProperty().SetColor(0.23, 0.37, 0.17)
axes.GetZAxesGridlinesProperty().SetColor(0.23, 0.37, 0.17)
...
render_window.SetWindowName("cube axes with grid lines")
