...
# Demonstrate vtkAMRSliceFilter on synthetic cell data generated from
...
# Synthetic wavelet source
img_src = vtkRTAnalyticSource()

# Convert point data to cell data
cell_data_converter = vtkPointDataToCellData()
cell_data_converter.SetInputConnection(img_src.GetOutputPort())

# Convert image to AMR with 3 levels
amr = vtkImageToAMR()
amr.SetInputConnection(cell_data_converter.GetOutputPort())
...
# Composite mapper with cell field data coloring
...
render_window.SetWindowName("amr slice filter cell data")
