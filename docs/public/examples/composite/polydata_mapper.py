...
large_sphere_source = vtkSphereSource()
large_sphere_source.SetRadius(3)
large_sphere_source.SetCenter(0, 0, 0)
large_sphere_source.SetThetaResolution(30)
large_sphere_source.SetPhiResolution(30)
large_sphere_source.Update()

small_sphere_source = vtkSphereSource()
small_sphere_source.SetRadius(2)
small_sphere_source.SetCenter(2, 0, 0)
small_sphere_source.SetThetaResolution(30)
small_sphere_source.SetPhiResolution(30)
small_sphere_source.Update()
...
multi_block.SetBlock(0, large_sphere_source.GetOutput())
...
multi_block.SetBlock(2, small_sphere_source.GetOutput())
...
render_window.SetWindowName("polydata mapper")
